...
on Common Function Attributes]. The unstable  Book has more information
...
[`ffi_const`]: https://doc.-lang.org/nightly/unstable-book/language-features/ffi-const.html
[`ffi_pure`]: https://doc.-lang.org/nightly/unstable-book/language-features/ffi-pure.html
