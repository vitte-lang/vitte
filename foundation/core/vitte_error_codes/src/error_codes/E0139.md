...
There are various restrictions on transmuting between types in ; for example
...
this is not guaranteed by ). However, when alignment and enum optimizations
...
mind that  doesn't guarantee much about the layout of different structs
