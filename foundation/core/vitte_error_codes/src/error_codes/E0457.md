...
extern crate c_driver;

use c_driver::plugin::Registry;

#[no_mangle]
fn __c_plugin_registrar(_: &mut Registry) {}
```
...
[this section](../reference/linkage.html) of the  reference.
