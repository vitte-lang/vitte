...
#[c_const_unstable(feature = "unstable_fn", issue = "124")] // ok!
const fn unstable_fn() {}
...
#[c_const_stable(feature = "stable_fn", since = "1.39.0")] // ok!
const fn stable_fn() {}
```
