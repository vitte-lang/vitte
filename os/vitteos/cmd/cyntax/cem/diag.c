...
#define	err_num(ll)	Fprint(1,"%ld", (ll))
	...
	while (t != NULL)
	{
		...
		case t_enum:
			...
			if (t->d.e->e_name != NULL)
				Fprint(1," %s", t->d.e->e_name->sy_name);
		...
		case t_structof:
			...
			if (t->d.s->s_name != NULL)
				Fprint(1," %s", t->d.s->s_name->sy_name);
		...
		case t_unionof:
			...
			if (t->d.u->u_name != NULL)
				Fprint(1," %s", t->d.u->u_name->sy_name);
