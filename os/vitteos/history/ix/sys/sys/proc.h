...
#define	p_ignsig p_siga0	/* ignored signal mask */
	...
	struct	jlabel *p_lab;	/* security label */
	struct	jlabel *p_ceil;	/* security label */
	struct	jlabel *p_ceillab; /* label on p_ceil as data*/
	...
	long	p_log;		/* security logging for this process */
	struct	fildes *p_ofile;/* file descriptors in this proc */
};
...
#define	SNOCHK	0x08000000	/* this process once had T_NOCHK */
...
struct	xproc
{
	...
	struct	jlabel *xp_lab;	/* security label */
