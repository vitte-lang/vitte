...
REQUIRED_SYMBOLS = {
    ...
    'typeck_infer': [
        ...
        'infer_call_type',
        'infer_call_substitutions',
        'infer_pattern_substitutions',
        'resolved_call_generic_arguments',
        'substitute_type',
    ...
    'typeck_tests': [
        ...
        'test_typed_hir_preserves_explicit_generic_instance',
        'test_impl_method_dispatch_rejects_ambiguous_traits',
        'test_match_bool_is_exhaustive_with_both_literals',
        'test_match_pick_reports_the_missing_variant',
        'test_match_pick_variants_can_be_exhaustive_without_fallback',
        ...
        'test_canonical_hir_covers_retired_complete_surface',
