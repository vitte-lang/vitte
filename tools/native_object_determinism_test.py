...
int main(int argc, char **argv) {
  ...
  if (vitte_host_emit_assembly_object(text(assembly), text("clang"), text("x86_64-unknown-linux-gnu"), text(""), text(argv[1]), 1) != 0) {
    return 65;
  }
  if (vitte_host_emit_assembly_object(text(assembly), text("clang"), text("x86_64-unknown-linux-gnu"), text(""), text(argv[2]), 1) != 0) {
    return 66;
  }
  {
  ...
  if (vitte_host_emit_assembly_object(text(release_assembly), text("clang"), text("x86_64-unknown-linux-gnu"), text(""), text(argv[3]), 0) != 0) {
    return 71;
  }
