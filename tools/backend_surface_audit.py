...
def main() -> int:
    checks: list[tuple[str, str, str]] = [
        ...
        ("src/vitte/compiler/backend/api.vit", "proc backend_runtime_defines_native_symbol", "backend facade must expose canonical runtime symbol lookup"),
        ...
        ("src/vitte/compiler/driver/compiler.vit", "use vitte/compiler/backend/api.{ backend_runtime_defines_native_symbol }", "runtime driver must use canonical runtime symbol lookup"),
