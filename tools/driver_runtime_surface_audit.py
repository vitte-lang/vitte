...
def main() -> int:
    required_checks: list[tuple[str, str, str]] = [
        ...
        ("src/vitte/compiler/driver/compiler.vit", 'COMPILER_DRIVER_SOURCE=src/vitte/compiler/driver/compiler.vit', "runtime driver must identify its canonical source provenance"),
