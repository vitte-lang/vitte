...
REQUIRED_NEXT_STEP_FRAGMENTS = {
    ...
    "alloc/btree.vitl": ("type BTreeMap<K, V>", "proc btree_map_insert<K, V>", "proc btree_map_get<K, V>"),
    "alloc/collections.vitl": ("form HashMap<K, V>", "form HashSet<T>", "form BTreeMap<K, V>", "form BTreeSet<T>", "form Deque<T>", "form SmallVec<T, N>", "proc hashmap_insert<K, V>", "proc btreemap_insert<K, V>", "proc deque_push_back<T>", "proc smallvec_push<T, N>"),
    ...
    "std/env.vitl": ("form EnvError", "proc args", "proc var", "proc current_dir", "proc args_os", "proc var_unicode", "proc config_dir", "proc data_dir", "proc cache_dir"),
    ...
    "std/process.vitl": ("form ExitStatus", "form Command", "form Child", "form Output", "form Pipe", "proc pipe", "proc spawn", "proc status", "proc output", "proc exit", "proc stdin_mode", "proc stdout_mode"),
    ...
    "std/thread.vitl": ("form ThreadId", "form JoinHandle<T>", "form ThreadBuilder", "proc spawn<T>", "proc spawn_with<T>", "proc join<T>", "proc sleep", "proc current_id"),
    "std/sync.vitl": ("form Mutex<T>", "form RwLock<T>", "form Once", "form Condvar", "form Atomic<T>", "form MutexGuard<T>", "proc lock<T>", "proc read_guard<T>", "proc atomic_compare_exchange<T>"),
    "std/net.vitl": ("form TcpStream", "form TcpListener", "form UdpSocket", "form Timeout", "proc dns_lookup", "proc tcp_connect", "proc tcp_connect_timeout", "proc udp_bind", "proc tcp_read", "proc tcp_write"),
    "std/hash.vitl": ("form StableHasher", "form RandomHasher", "form SipHasher", "proc sip_hasher", "proc stable_finish"),
    "std/random.vitl": ("form Prng", "proc prng", "proc next_u64", "proc os_entropy", "proc random_f64"),
    "std/format.vitl": ("pick FormatBase", "form FormatSpec", "form Display<T>", "form Debug<T>", "proc format_int", "proc pad_left"),
    "std/parse.vitl": ("form ParseError", "proc parse_bool", "proc parse_i64", "proc parse_utf8", "proc parse_error"),
    "std/testing.vitl": ("form TestError", "form Fixture<T>", "form Snapshot", "proc assert_eq<T>", "proc parameterized<T>"),
    "std/bench.vitl": ("form Benchmark", "form BenchReport", "proc run", "proc threshold", "proc report_text"),
    ...
    "std/http.vitl": ("form HeaderMap", "form Request", "form Response", "form HttpError", "proc header_insert", "proc http_get", "proc http_post", "proc http_send", "proc follow_redirects"),
