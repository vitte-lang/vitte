...
REQUIRED_NEXT_STEP_FRAGMENTS = {
    ...
    "std/testing.vitl": ("form TestError", "form Fixture<T>", "form Snapshot", "form TestRunner", "proc discover_tests", "proc assert_eq<T>", "proc with_fixture<T>", "proc parameterized<T>", "proc run_runner"),
    ...
    "std/log.vitl": ("pick LogLevel", "pick LogSinkKind", "form LogRecord", "form LogSink", "form Logger", "proc logger", "proc logger_with_sink", "proc compact_record", "proc warn", "proc error"),
    "std/cli.vitl": ("form Flag", "form Subcommand", "form CliApp", "form CliMatches", "pick CliErrorKind", "proc subcommand", "proc add_subcommand", "proc parse", "proc help", "proc subcommand_help"),
