...
FIX = ROOT / "src" / "vitte" / "compiler" / "diagnostics" / "fix.vit"
...
REQUIRED_NEEDLES: tuple[tuple[Path, str], ...] = (
    ...
    (DIAGNOSTIC, "net_score: string"),
    (DIAGNOSTIC, "errors_removed: u64"),
    (DIAGNOSTIC, "new_errors: u64"),
    (DIAGNOSTIC, "before_fingerprint: string"),
    (DIAGNOSTIC, "after_fingerprint: string"),
    (DIAGNOSTIC, "structural_fingerprint: string"),
    (DIAGNOSTIC, "error_moved: bool"),
    (DIAGNOSTIC, "behavior_changed: bool"),
    (DIAGNOSTIC, "pick DiagnosticCounterfactualLevel"),
    (DIAGNOSTIC, "pick DiagnosticFixMode"),
    (DIAGNOSTIC, "form DiagnosticFixTransaction"),
    (DIAGNOSTIC, "diagnostic_suggestion_public_score"),
    (DIAGNOSTIC, "diagnostic_net_score"),
    (DIAGNOSTIC, "diagnostic_suggestion_with_quality"),
    (DIAGNOSTIC, "diagnostic_suggestion_modifies_code"),
    (DIAGNOSTIC, "diagnostic_suggestion_is_auto_safe"),
    (DIAGNOSTIC, "diagnostic_sanitize_unverified_code_suggestions"),
    (DIAGNOSTIC, "diagnostic_deduplicate_structural_hypotheses"),
    (DIAGNOSTIC, "and not suggestion.counterfactual_verified"),
    (DIAGNOSTIC, "set out.machine_applicable = false;"),
    ...
    (DIAGNOSTIC, "diagnostic_catalog_counterfactual_result"),
    ...
    (JSON_RENDERER, "\"risk\""),
    (JSON_RENDERER, "\"score\""),
    (JSON_RENDERER, "\"net_score\""),
    (JSON_RENDERER, "\"errors_removed\""),
    (JSON_RENDERER, "\"new_errors\""),
    (JSON_RENDERER, "\"before_fingerprint\""),
    (JSON_RENDERER, "\"after_fingerprint\""),
    (JSON_RENDERER, "\"structural_fingerprint\""),
    (JSON_RENDERER, "\"error_moved\""),
    (JSON_RENDERER, "\"behavior_changed\""),
    (COUNTERFACTUAL, "counterfactual_hypothesis_score"),
    (COUNTERFACTUAL, "CounterfactualRecompileCacheEntry"),
    (COUNTERFACTUAL, "counterfactual_cache_lookup"),
    (COUNTERFACTUAL, "counterfactual_source_fingerprint"),
    (COUNTERFACTUAL, "counterfactual_net_score"),
    (FIX, "diagnostic_fix_mode_from_flag"),
    (FIX, "\"--fix\""),
    (FIX, "\"--fix-safe\""),
    (FIX, "\"--fix-preview\""),
    (FIX, "\"--fix-why\""),
    (FIX, "diagnostic_fix_transaction_from_diagnostic"),
    (FIX, "--fix refused because behavior_changed=true"),
    (FIX, "diagnostic_fix_transaction_rollback"),
    (FIX, "diagnostic_verified_code_modifying_suggestions"),
    (FIX, "diagnostic_counterfactual_level_from_text"),
    (PIPELINE, "detect_fix_flag"),
    (PIPELINE, "detect_counterfactual_level"),
    (PIPELINE, "--counterfactual-level="),
    (LSP, "disabled: bool"),
    ...
    (TESTS, "test_diagnostic_fix_modes_transaction_contract"),
    (TESTS, "\\\"strategy\\\": \\\""),
    (TESTS, "\\\"proof\\\": \\\""),
    (TESTS, "\\\"score\\\": "),
    (TESTS, "\\\"net_score\\\": \\\""),
