...
CHECKS: tuple[tuple[Path, str], ...] = (
    ...
    (CANONICAL, "diagnostic_catalog_counterfactual_result"),
    (CANONICAL, "diagnostic_suggestion_modifies_code"),
    (CANONICAL, "and not suggestion.counterfactual_verified"),
    ...
    (COUNTERFACTUAL, "form CounterfactualCacheKey"),
    (COUNTERFACTUAL, "form CounterfactualVirtualDiff"),
    (COUNTERFACTUAL, "form CounterfactualVirtualResult"),
    (COUNTERFACTUAL, "pick CounterfactualPipelinePhase"),
    (COUNTERFACTUAL, "counterfactual_cache_key"),
    (COUNTERFACTUAL, "counterfactual_cache_key_text"),
    (COUNTERFACTUAL, "counterfactual_virtual_diff"),
    ...
    (COUNTERFACTUAL, "counterfactual_hypothesis_is_better"),
    (COUNTERFACTUAL, "counterfactual_rank_three_hypotheses"),
    (COUNTERFACTUAL, "counterfactual_hypothesis_has_new_error"),
    (COUNTERFACTUAL, "counterfactual_hypothesis_changes_behavior"),
    (COUNTERFACTUAL, "counterfactual_hypothesis_moves_error"),
    ...
    (TESTS, "test_counterfactual_ranking_prefers_verified_low_risk_fix"),
    (TESTS, "counterfactual_hypothesis_score(hypotheses[1]) == 0 as u64"),
    (TESTS, "ranked[0].message == hypotheses[0].message"),
    (TESTS, "counterfactual_virtual_result_is_verified(success)"),
    (TESTS, "!counterfactual_virtual_result_is_verified(failure)"),
    (TESTS, "test_counterfactual_cache_and_diff_contract"),
