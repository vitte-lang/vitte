...
def check_relational_diagnostic_contract() -> list[str]:
    ...
    required_fragments = (
        ...
        (DIAGNOSTICS_MIGRATION_CHECK, "migration_debt_counts"),
        (DIAGNOSTICS_MIGRATION_CHECK, "render_migration_debt_counts"),
        (DIAGNOSTICS_MIGRATION_CHECK, "[diagnostics-migration] unmigrated="),
        (DIAGNOSTICS_MIGRATION_CHECK, "REMOVED_LEGACY_DIAGNOSTIC_PATHS"),
        (DIAGNOSTICS_MIGRATION_CHECK, "validate_legacy_system_removed"),
        (DIAGNOSTICS_MIGRATION_CHECK, "removed legacy diagnostic system file must not exist"),
        ...
        (DIAGNOSTIC_LSP, "lsp_cli_diagnostic_parity_contract"),
        (DIAGNOSTIC_LSP, "lsp.code == diagnostic.code"),
        (DIAGNOSTIC_LSP, "lsp.message == diagnostic.message"),
        (DIAGNOSTIC_LSP, "share lsp_cli_diagnostic_parity_contract"),
        ...
        (DRIVER_COMPILER, "cli_check_build_diagnostic_parity_contract"),
        (DRIVER_COMPILER, "build diagnostic validation must use the same check mode as vitte check"),
        (DRIVER_COMPILER, "cli_check_build_diagnostic_parity_contract(CompilerMode::Check, validate_opts.mode)"),
        ...
        (CANONICAL_DIAGNOSTIC, "DIAGNOSTIC_PUBLIC_API_STATUS"),
        (CANONICAL_DIAGNOSTIC, "diagnostic_public_api_status"),
        (CANONICAL_DIAGNOSTIC, "diagnostic_public_api_freeze_contract"),
        (CANONICAL_DIAGNOSTIC, "migration-freeze-pending"),
        (CANONICAL_DIAGNOSTIC, "diagnostic_public_api_status() == \"frozen\""),
        (CANONICAL_DIAGNOSTIC, "share diagnostic_public_api_freeze_contract"),
        ...
        (DIAGNOSTICS_DOC, "The public API status is `migration-freeze-pending`"),
        (DIAGNOSTICS_DOC, "the status must be changed to `frozen`"),
