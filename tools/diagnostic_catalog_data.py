...
PUBLIC_EXTRA_CODES: tuple[str, ...] = (
    ...
    "DRIVER_E_MISSING_COMMAND",
    "DRIVER_E_MISSING_OPTION_VALUE",
    "DRIVER_E_SOURCE_UNREADABLE",
    "DRIVER_E_INVALID_CONFIGURATION",
    ...
    "E_BOOTSTRAP_VERSION",
    "INSTALL_E_VITTE_HELP_FAILED",
    "INSTALL_E_VITTEC_HELP_FAILED",
    "INSTALL_E_PACKAGE_IMPORT_TEST_FAILED",
    "INSTALL_E_COMPLETION_MISSING",
    "INSTALL_E_CC_MISSING",
    "INSTALL_E_LIPO_MISSING",
    "INSTALL_E_MACOS_REQUIRED",
    "INSTALL_E_PACKAGE_SOURCE_MISSING",
    "INSTALL_E_POSTINSTALL_HELP_FAILED",
    "INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED",
    "INSTALL_E_POSTINSTALL_COMPLETION_MISSING",
    "LIMIT_FILE_SIZE_MAX",
...
MESSAGE_OVERRIDES: dict[str, str] = {
    ...
    "BACKEND_E_MISSING_C_COMPILER": "required C compiler was not found",
    "LINK_E_COMMAND_FAILED": "linker command failed",
