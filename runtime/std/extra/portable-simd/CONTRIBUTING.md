...
4. Test it: `cargo test`. Remember to enable whatever SIMD features you intend to test by setting `FLAGS`.
...
A large amount of the core SIMD implementation is found in the c_codegen_* crates in the [main c repo](https://github.com/-lang/). In addition, actual platform-specific functions are implemented in [stdarch]. Not all changes to `std::simd` require interacting with either of these, but if you're wondering where something is and it doesn't seem to be in this repository, those might be where to start looking.

## Questions? Concerns? Need Help?

Please feel free to ask in the [#project-portable-simd][zulip-portable-simd] stream on the [-lang Zulip][zulip] for help with making changes to `std::simd`!
...
[zulip-portable-simd]: https://-lang.zulipchat.com/#narrow/stream/257879-project-portable-simd
[zulip-compiler-help]: https://-lang.zulipchat.com/#narrow/stream/182449-t-compiler.2Fhelp
