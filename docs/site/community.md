...
- [Épinglé] Commencer par le bon fil
  ...
  - [Ouvrir les diagnostics](/site/diagnostics.md) · [Voir la source](/site/source.md)
- [@_admin] Avancée globale du projet
  ...
  - [Relire la documentation](/site/doc.md) · [Voir la publication 2.1.1](/site/download.md) · [Lire la source](/site/source.md)
- [@_admin] Stdlib étendue: fil de référence
  ...
  - [Lire la stdlib](/book/chapters/17-stdlib.md) · [Voir le contrat](/book/compiler-stdlib-contract.md) · [Lire la source](/site/source.md)
- [@_admin] La CLI, expliquée simplement
  ...
  - [Voir les diagnostics](/site/diagnostics.md) · [Aller au téléchargement](/site/download.md) · [Lire la documentation](/site/doc.md)
- [@_vincent.rs] Stdlib, source et contrat de lecture
  ...
  - [Relire la stdlib](/book/chapters/17-stdlib.md) · [Voir le contrat](/book/compiler-stdlib-contract.md) · [Retour à la documentation](/site/doc.md)
- [@_roussov] stdlib/kernel: syntaxe nouvelle, exemple complet
  ...
  - [Relire la stdlib](/book/chapters/17-stdlib.md) · [Voir le contrat](/book/compiler-stdlib-contract.md) · [Lire la source](/site/source.md)
- [@_roussov] kernel: cas d'erreur et diagnostic attendu
  ...
  - [Voir les codes repères](/site/diagnostics.md) · [Relire la stdlib](/book/chapters/17-stdlib.md) · [Retour à la publication](/site/download.md)

## Tendance

- [Version 2.1.1](/site/download.md)
- [Documentation](/site/doc.md)
- [Codes repères](/site/diagnostics.md)
...
- [Suivre les annonces](/site/news.md)
