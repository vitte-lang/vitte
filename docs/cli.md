...
- `--dump-stdlib-map`  Print resolved stdlib module -> exported symbols.
...
- Diagnostics use stable layer prefixes:
  ...
  - `E1010..E1018`: module/stdlib import contract
  - `E200x`: IR/lowering
...
- Contract and ABI surface: `docs/compiler-stdlib-contract.md`, `docs/stdlib_abi_surface_v1.txt`.

Legacy flags (still supported):
- `mod api-diff` (alias of `mod contract-diff`)
- `--stdlib-profile` (alias of `--runtime-profile`)
