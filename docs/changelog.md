...
- Stage0 seed shell `REMOVED-SEED/REMOVED-SEED` now emits phase-explicit diagnostics for:
...
- Canonical readable seed source `REMOVED-SEED/src/main.vit` now mirrors the
