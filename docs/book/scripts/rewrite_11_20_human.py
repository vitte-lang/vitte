...
TARGETS = [
    Path('docs/book/chapters/11-collections.md'),
    Path('docs/book/chapters/12-pointeurs.md'),
    Path('docs/book/chapters/13-generiques.md'),
    ...
    Path('docs/book/chapters/20-repro.md'),
]
