...
Prérequis: chapitre précédent `docs/book/chapters/08-structures.md` et `docs/book/glossaire.md`.
Voir aussi: `docs/book/chapters/08-structures.md`, `docs/book/chapters/10-diagnostics.md`, `docs/book/glossaire.md`.
