...
Prérequis: `docs/book/chapters/10-diagnostics.md`, `docs/book/chapters/47-debugage-reproductible.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: Programmation defensive en entree/sortie devient clair quand on trace chaque étape du calcul. L'objectif est de relier ligne de code et effet concret sur la sortie.
...
1. `proc parse_nonempty(ok: bool) -> bool { give ok }` -> pose une règle clair de fonction.
