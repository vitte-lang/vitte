...
Prérequis: chapitre précédent `docs/book/chapters/26-projet-editor.md` et `docs/book/glossaire.md`.
Voir aussi: `docs/book/chapters/26-projet-editor.md`, `docs/book/chapters/28-conventions.md`, `docs/book/glossaire.md`.
...
3. Vérifiez la priorité opératoire dans `docs/book/grammar/precedence.md` si l’arbre attendu diverge.
4. Reproduisez avec un exemple minimal dans `tests/grammar/valid` ou `tests/grammar/invalid`.
5. Confirmez le diagnostic attendu dans `docs/book/grammar/diagnostics/expected`.

Voir aussi:
- `docs/book/chapters/31-erreurs-build.md` pour la table erreur -> correction.
- `docs/book/grammar/grammar-notes.md` pour les ambiguïtés connues.
...
- Index: `docs/book/grammar/railroad/README.md`
- Règles clés:
  - `docs/book/grammar/railroad/program.svg`
  - `docs/book/grammar/railroad/toplevel.svg`
  - `docs/book/grammar/railroad/stmt.svg`
  - `docs/book/grammar/railroad/expr.svg`
  - `docs/book/grammar/railroad/type_expr.svg`
