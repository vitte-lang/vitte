...
Prérequis: `docs/book/chapters/27-grammaire.md`, `docs/book/chapters/52-tests-grammaire-valid-invalid.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: Property-based testing pour le parser se comprend mieux en rejouant le programme comme un algorithme exécutable. Vous lisez les données entrantes, la condition évaluée, puis la valeur renvoyée.
...
Trouver automatiquement des cas d'erreur parser via generation de donnees.
...
```vit
// Scenario property based testing parser: execution complete et verifiable
