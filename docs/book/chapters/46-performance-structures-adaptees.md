...
Prérequis: `docs/book/chapters/08-structures.md`, `docs/book/chapters/11-collections.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: Performance: structures de donnees adaptees se comprend mieux en rejouant le programme comme un algorithme exécutable. Vous lisez les données entrantes, la condition évaluée, puis la valeur renvoyée.
...
1. `proc first(xs: [int]) -> int { give 0 }` -> pose une règle clair de fonction.
