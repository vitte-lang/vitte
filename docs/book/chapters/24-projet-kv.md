...
Prérequis: chapitre précédent `docs/book/chapters/23-projet-sys.md` et `docs/book/glossaire.md`.
Voir aussi: `docs/book/chapters/23-projet-sys.md`, `docs/book/chapters/25-projet-arduino.md`, `docs/book/glossaire.md`.
