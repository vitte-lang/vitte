...
Prérequis: `docs/book/chapters/15-pipeline.md`, `docs/book/chapters/27-grammaire.md`.
Voir aussi: `docs/book/chapters/10-diagnostics.md`, `docs/book/chapters/31-erreurs-build.md`.

## Problème Concret

Situation réelle: pour Modele mental du compilateur, la question n'est pas 'quella règle écrire' mais 'quel chemin le code prend vraiment'. Cette lecture par exécution évite les interprétations vagues.
...
2. Resolve/type: verifier symboles, imports, types et règles.
