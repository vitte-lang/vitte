...
Prérequis: `docs/book/chapters/15-pipeline.md`, `docs/book/chapters/31-erreurs-build.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: Tests de non-regression compilateur se comprend mieux en rejouant le programme comme un algorithme exécutable. Vous lisez les données entrantes, la condition évaluée, puis la valeur renvoyée.
