...
Prérequis: `docs/book/chapters/13-generiques.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: pour Generiques: design et compromis, la question n'est pas 'quella règle écrire' mais 'quel chemin le code prend vraiment'. Cette lecture par exécution évite les interprétations vagues.
...
```vit
// Scenario generiques design compromis: execution complete et verifiable
