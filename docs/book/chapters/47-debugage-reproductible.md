...
Prérequis: `docs/book/chapters/20-repro.md`, `docs/book/chapters/31-erreurs-build.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: pour Debogage reproductible, la question n'est pas 'quella règle écrire' mais 'quel chemin le code prend vraiment'. Cette lecture par exécution évite les interprétations vagues.
