...
Prérequis: chapitre précédent `docs/book/chapters/27-grammaire.md` et `docs/book/glossaire.md`.
Voir aussi: `docs/book/chapters/27-grammaire.md`, `docs/book/chapters/29-style.md`, `docs/book/glossaire.md`.
