...
Prérequis: chapitre précédent `docs/book/chapters/01-demarrer.md` et `docs/book/glossaire.md`.
Voir aussi: `docs/book/chapters/01-demarrer.md`, `docs/book/chapters/03-projet.md`, `docs/book/glossaire.md`.
