...
Prérequis: `docs/book/chapters/14-macros.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: pour Macros: cas d'usage et limites, la question n'est pas 'quella règle écrire' mais 'quel chemin le code prend vraiment'. Cette lecture par exécution évite les interprétations vagues.
...
```vit
// Scenario macros cas usage limites: execution complete et verifiable
