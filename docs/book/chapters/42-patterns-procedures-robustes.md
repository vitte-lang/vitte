...
Prérequis: `docs/book/chapters/06-procedures.md`, `docs/book/chapters/07-controle.md`.
Voir aussi: `docs/book/chapters/18-tests.md`.

## Problème Concret

Situation réelle: dans ce chapitre sur Patterns de procedures robustes, l'échec vient souvent d'une décision mal ordonnée plutôt que d'une faute de syntaxe. On suit donc le flux exact: entrée, test, branche, sortie.
...
Ecrire des `proc` lisibles, testables et robustes face aux cas d'erreur.

## Patterns recommandes

1. Gardes en tete (fail fast).
2. Règle explicite en signature.
...
2. Les cas d'erreur sont traites avant le nominal.
3. Un test couvre chaque test.

## Exemples progressifs (N1 -> N3)

### N1 (base): test minimale
...
```vit
// Scenario patterns procedures robustes: execution complete et verifiable
