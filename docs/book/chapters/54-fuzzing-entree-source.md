...
Prérequis: `docs/book/chapters/53-property-based-testing-parser.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: Fuzzing de l'entree source se comprend mieux en rejouant le programme comme un algorithme exécutable. Vous lisez les données entrantes, la condition évaluée, puis la valeur renvoyée.
