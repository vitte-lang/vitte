...
Prérequis: `docs/book/chapters/18-tests.md`, `docs/book/chapters/31-erreurs-build.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: dans ce chapitre sur Revue de code orientee risques, l'échec vient souvent d'une décision mal ordonnée plutôt que d'une faute de syntaxe. On suit donc le flux exact: entrée, test, branche, sortie.
...
```bash
rg -n "parse_port|give" docs/book/chapters src tests
```
...
```vit
// Scenario revue code orientee risques: execution complete et verifiable
