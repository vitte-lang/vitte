...
Prérequis: `docs/book/chapters/10-diagnostics.md`, `docs/book/chapters/35-anatomie-message-erreur.md`.
Voir aussi: à définir.

## Problème Concret

Situation réelle: Gestion des erreurs semantiques se comprend mieux en rejouant le programme comme un algorithme exécutable. Vous lisez les données entrantes, la condition évaluée, puis la valeur renvoyée.
