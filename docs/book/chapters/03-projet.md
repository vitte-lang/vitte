...
Prérequis: chapitre précédent `docs/book/chapters/02-philosophie.md` et `docs/book/glossaire.md`.
Voir aussi: `docs/book/chapters/02-philosophie.md`, `docs/book/chapters/04-syntaxe.md`, `docs/book/glossaire.md`.
