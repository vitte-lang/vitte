...
Prérequis: chapitre précédent `docs/book/chapters/10-diagnostics.md` et `docs/book/glossaire.md`.
Voir aussi: `docs/book/chapters/10-diagnostics.md`, `docs/book/chapters/12-pointeurs.md`, `docs/book/glossaire.md`.
