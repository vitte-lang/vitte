...
Nouveau point d'entrée débutant: `docs/book/poche/SOMMAIRE.md` (format tout-en-poche).
...
Parcours recommandé si le livre semble trop dense: `docs/book/poche/SOMMAIRE.md`.
