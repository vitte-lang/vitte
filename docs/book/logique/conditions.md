...
Cette page se rattache aux mecanismes de `if`, `and`, `or`, `not` et `otherwise`, details dans `docs/book/chapters/keywords/if.md`, `docs/book/chapters/keywords/and.md`, `docs/book/chapters/keywords/or.md`, `docs/book/chapters/keywords/not.md` et `docs/book/chapters/keywords/otherwise.md`.
