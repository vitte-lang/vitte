# 55. Securite memoire et invariants (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/55-securite-memoire-invariants.md`.

## Objectif

Comprendre securite memoire et invariants de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de securite memoire et invariants, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/55-securite-memoire-invariants.md`.
