# 16. Interop et ABI (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/16-interop.md`.

## Objectif

Comprendre interop et abi de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de interop et abi, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/16-interop.md`.
