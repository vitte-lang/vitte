# 47. Debogage reproductible (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/47-debugage-reproductible.md`.

## Objectif

Comprendre debogage reproductible de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de debogage reproductible, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/47-debugage-reproductible.md`.
