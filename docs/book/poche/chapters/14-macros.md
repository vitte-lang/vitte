# 14. Macros (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/14-macros.md`.

## Objectif

Comprendre macros de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de macros, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/14-macros.md`.
