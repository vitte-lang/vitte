# 27. Grammaire du langage (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/27-grammaire.md`.

## Objectif

Comprendre grammaire du langage de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de grammaire du langage, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/27-grammaire.md`.
