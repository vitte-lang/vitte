# 59. Revue de code orientee risques (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/59-revue-code-orientee-risques.md`.

## Objectif

Comprendre revue de code orientee risques de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de revue de code orientee risques, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/59-revue-code-orientee-risques.md`.
