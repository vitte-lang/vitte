# 67. Generiques: design et compromis (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/67-generiques-design-compromis.md`.

## Objectif

Comprendre generiques: design et compromis de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de generiques: design et compromis, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/67-generiques-design-compromis.md`.
