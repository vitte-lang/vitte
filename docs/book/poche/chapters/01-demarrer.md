# 01. Démarrer avec Vitte (version poche)
...
Comprendre démarrer de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de démarrer, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/01-demarrer.md`.
