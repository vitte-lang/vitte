# 60. Documentation technique durable (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/60-documentation-technique-durable.md`.

## Objectif

Comprendre documentation technique durable de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de documentation technique durable, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/60-documentation-technique-durable.md`.
