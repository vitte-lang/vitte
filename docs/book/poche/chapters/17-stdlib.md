# 17. Stdlib (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/17-stdlib.md`.

## Objectif

Comprendre la stdlib de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de stdlib, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/17-stdlib.md`.
