# 66. Macros: cas d'usage et limites (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/66-macros-cas-usage-limites.md`.

## Objectif

Comprendre macros: cas d'usage et limites de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de macros: cas d'usage et limites, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/66-macros-cas-usage-limites.md`.
