# 56. Programmation defensive en entree/sortie (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/56-programmation-defensive-entree-sortie.md`.

## Objectif

Comprendre programmation defensive en entree/sortie de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de programmation defensive en entree/sortie, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/56-programmation-defensive-entree-sortie.md`.
