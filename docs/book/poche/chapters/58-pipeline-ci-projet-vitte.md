# 58. Pipeline CI pour un projet Vitte (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/58-pipeline-ci-projet-vitte.md`.

## Objectif

Comprendre pipeline ci pour un projet de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de pipeline ci pour un projet, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/58-pipeline-ci-projet-vitte.md`.
