# 20. Reproductibilité (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/20-repro.md`.

## Objectif

Comprendre reproductibilité de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de reproductibilité, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/20-repro.md`.
