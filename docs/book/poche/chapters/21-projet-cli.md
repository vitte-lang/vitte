# 21. Projet guide CLI (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/21-projet-cli.md`.

## Objectif

Comprendre projet guide cli de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de projet guide cli, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/21-projet-cli.md`.
