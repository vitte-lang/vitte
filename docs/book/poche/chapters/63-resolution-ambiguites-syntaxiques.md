# 63. Resolution d'ambiguites syntaxiques (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/63-resolution-ambiguites-syntaxiques.md`.

## Objectif

Comprendre resolution d'ambiguites syntaxiques de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de resolution d'ambiguites syntaxiques, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/63-resolution-ambiguites-syntaxiques.md`.
