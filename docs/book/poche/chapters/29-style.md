# 29. Style d'architecture (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/29-style.md`.

## Objectif

Comprendre style d'architecture de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de style d'architecture, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/29-style.md`.
