# 31. Erreurs de build (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/31-erreurs-build.md`.

## Objectif

Comprendre erreurs de build de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de erreurs de build, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/31-erreurs-build.md`.
