# 11. Collections et itération (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/11-collections.md`.

## Objectif

Comprendre collections et itération de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de collections et itération, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/11-collections.md`.
