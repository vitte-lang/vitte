# 33. Chapitres suggérés (max) (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/33-chapitres-suggeres.md`.

## Objectif

Comprendre chapitres suggérés (max) de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de chapitres suggérés (max), puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/33-chapitres-suggeres.md`.
