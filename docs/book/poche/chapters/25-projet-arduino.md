# 25. Projet guide Arduino (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/25-projet-arduino.md`.

## Objectif

Comprendre projet guide arduino de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de projet guide arduino, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/25-projet-arduino.md`.
