# 02. Philosophie du langage (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/02-philosophie.md`.

## Objectif

Comprendre philosophie du langage de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de philosophie du langage, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/02-philosophie.md`.
