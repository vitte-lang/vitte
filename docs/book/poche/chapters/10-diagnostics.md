# 10. Diagnostics et erreurs (version poche)
...
Comprendre diagnostics et erreurs de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de diagnostics et erreurs, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/10-diagnostics.md`.
