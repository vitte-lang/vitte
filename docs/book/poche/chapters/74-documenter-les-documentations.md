# 74. Documenter les documentations (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/74-documenter-les-documentations.md`.

## Objectif

Comprendre documenter les documentations de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de documenter les documentations, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/74-documenter-les-documentations.md`.
