# 32. Catalogue Des Modules Vitte (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/32-catalogue-modules.md`.

## Objectif

Comprendre catalogue des modules de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de catalogue des modules, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/32-catalogue-modules.md`.
