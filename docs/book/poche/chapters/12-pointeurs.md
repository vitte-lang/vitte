# 12. Pointeurs, références et mémoire (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/12-pointeurs.md`.

## Objectif

Comprendre pointeurs, références et mémoire de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de pointeurs, références et mémoire, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/12-pointeurs.md`.
