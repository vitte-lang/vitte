# 00. Préface (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/00-preface.md`.

## Objectif

Comprendre préface de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de préface, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/00-preface.md`.
