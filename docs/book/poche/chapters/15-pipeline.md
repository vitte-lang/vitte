# 15. Pipeline compilateur (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/15-pipeline.md`.

## Objectif

Comprendre pipeline compilateur de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de pipeline compilateur, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/15-pipeline.md`.
