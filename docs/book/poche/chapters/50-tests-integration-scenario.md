# 50. Tests d'integration orientes scenario (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/50-tests-integration-scenario.md`.

## Objectif

Comprendre tests d'integration orientes scenario de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de tests d'integration orientes scenario, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/50-tests-integration-scenario.md`.
