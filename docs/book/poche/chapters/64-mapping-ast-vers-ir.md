# 64. Mapping AST -> IR (vue pratique) (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/64-mapping-ast-vers-ir.md`.

## Objectif

Comprendre mapping ast -> ir (vue pratique) de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de mapping ast -> ir (vue pratique), puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/64-mapping-ast-vers-ir.md`.
