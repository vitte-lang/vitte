# 06. Procédures et règles (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/06-procedures.md`.

## Objectif

Comprendre procédures et règles de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de procédures et règles, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/06-procedures.md`.
