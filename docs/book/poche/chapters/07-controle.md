# 07. Instructions de contrôle (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/07-controle.md`.

## Objectif

Comprendre instructions de contrôle de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de instructions de contrôle, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/07-controle.md`.
