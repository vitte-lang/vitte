# 52. Tests de grammaire (valid/invalid corpus) (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/52-tests-grammaire-valid-invalid.md`.

## Objectif

Comprendre tests de grammaire (valid/invalid corpus) de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de tests de grammaire (valid/invalid corpus), puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/52-tests-grammaire-valid-invalid.md`.
