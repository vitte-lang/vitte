# 68. Architecture hexagonale en Vitte (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/68-architecture-hexagonale-vitte.md`.

## Objectif

Comprendre architecture hexagonale en de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de architecture hexagonale en, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/68-architecture-hexagonale-vitte.md`.
