# 53. Property-based testing pour le parser (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/53-property-based-testing-parser.md`.

## Objectif

Comprendre property-based testing pour le parser de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de property-based testing pour le parser, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/53-property-based-testing-parser.md`.
