# 45. Performance: allocations et copies (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/45-performance-allocations-copies.md`.

## Objectif

Comprendre performance: allocations et copies de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de performance: allocations et copies, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/45-performance-allocations-copies.md`.
