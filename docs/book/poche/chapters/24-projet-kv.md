# 24. Projet guide KV store (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/24-projet-kv.md`.

## Objectif

Comprendre projet guide kv store de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de projet guide kv store, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/24-projet-kv.md`.
