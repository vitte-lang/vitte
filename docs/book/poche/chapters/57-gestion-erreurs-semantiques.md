# 57. Gestion des erreurs semantiques (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/57-gestion-erreurs-semantiques.md`.

## Objectif

Comprendre gestion des erreurs semantiques de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de gestion des erreurs semantiques, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/57-gestion-erreurs-semantiques.md`.
