# 20a. Architecture globale du langage (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/20a-architecture-globale.md`.

## Objectif

Comprendre architecture globale du langage de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de architecture globale du langage, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/20a-architecture-globale.md`.
