# 54. Fuzzing de l'entree source (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/54-fuzzing-entree-source.md`.

## Objectif

Comprendre fuzzing de l'entree source de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de fuzzing de l'entree source, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/54-fuzzing-entree-source.md`.
