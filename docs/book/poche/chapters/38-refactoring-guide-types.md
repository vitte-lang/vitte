# 38. Refactoring guide par les types (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/38-refactoring-guide-types.md`.

## Objectif

Comprendre refactoring guide par les types de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de refactoring guide par les types, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/38-refactoring-guide-types.md`.
