# 30. FAQ (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/30-faq.md`.

## Objectif

Comprendre faq de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de faq, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/30-faq.md`.
