# 69. Projet complet CLI production-ready (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/69-projet-cli-production-ready.md`.

## Objectif

Comprendre projet complet cli production-ready de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de projet complet cli production-ready, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/69-projet-cli-production-ready.md`.
