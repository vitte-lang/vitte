# 13. Génériques (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/13-generiques.md`.

## Objectif

Comprendre génériques de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de génériques, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/13-generiques.md`.
