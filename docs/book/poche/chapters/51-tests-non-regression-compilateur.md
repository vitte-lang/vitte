# 51. Tests de non-regression compilateur (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/51-tests-non-regression-compilateur.md`.

## Objectif

Comprendre tests de non-regression compilateur de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de tests de non-regression compilateur, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/51-tests-non-regression-compilateur.md`.
