# 70. Projet complet HTTP production-ready (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/70-projet-http-production-ready.md`.

## Objectif

Comprendre projet complet http production-ready de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de projet complet http production-ready, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/70-projet-http-production-ready.md`.
