# 04. Syntaxe essentielle (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/04-syntaxe.md`.

## Objectif

Comprendre syntaxe essentielle de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de syntaxe essentielle, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/04-syntaxe.md`.
