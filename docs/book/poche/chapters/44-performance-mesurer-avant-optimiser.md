# 44. Performance: mesurer avant d'optimiser (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/44-performance-mesurer-avant-optimiser.md`.

## Objectif

Comprendre performance: mesurer avant d'optimiser de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de performance: mesurer avant d'optimiser, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/44-performance-mesurer-avant-optimiser.md`.
