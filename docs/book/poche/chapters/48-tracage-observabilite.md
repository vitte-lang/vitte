# 48. Tracage et observabilite (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/48-tracage-observabilite.md`.

## Objectif

Comprendre tracage et observabilite de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de tracage et observabilite, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/48-tracage-observabilite.md`.
