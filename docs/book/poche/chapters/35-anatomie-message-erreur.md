# 35. Anatomie d'un message d'erreur (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/35-anatomie-message-erreur.md`.

## Objectif

Comprendre anatomie d'un message d'erreur de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de anatomie d'un message d'erreur, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/35-anatomie-message-erreur.md`.
