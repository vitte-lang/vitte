# 72. Projet embarque (contraintes mémoire/temps) (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/72-projet-embarque-contraintes.md`.

## Objectif

Comprendre projet embarque (contraintes mémoire/temps) de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de projet embarque (contraintes mémoire/temps), puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/72-projet-embarque-contraintes.md`.
