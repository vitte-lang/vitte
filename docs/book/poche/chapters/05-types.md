# 05. Types et valeurs (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/05-types.md`.

## Objectif

Comprendre types et valeurs de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de types et valeurs, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/05-types.md`.
