# 62. Lecture avancee de l'EBNF du langage (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/62-lecture-avancee-ebnf.md`.

## Objectif

Comprendre lecture avancee de l'ebnf du langage de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de lecture avancee de l'ebnf du langage, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/62-lecture-avancee-ebnf.md`.
