# 23. Projet guide Système (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/23-projet-sys.md`.

## Objectif

Comprendre projet guide système de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de projet guide système, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/23-projet-sys.md`.
