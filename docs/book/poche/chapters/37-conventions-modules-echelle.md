# 37. Conventions de modules a grande echelle (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/37-conventions-modules-echelle.md`.

## Objectif

Comprendre conventions de modules a grande echelle de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de conventions de modules a grande echelle, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/37-conventions-modules-echelle.md`.
