# 49. Ecriture de tests unitaires lisibles (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/49-tests-unitaires-lisibles.md`.

## Objectif

Comprendre ecriture de tests unitaires lisibles de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de ecriture de tests unitaires lisibles, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/49-tests-unitaires-lisibles.md`.
