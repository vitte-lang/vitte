# 39. Design d'API publiques stables (version poche)

Prérequis: `docs/book/poche/SOMMAIRE.md`.
Voir aussi: `docs/book/chapters/39-design-api-publiques-stables.md`.

## Objectif

Comprendre design d'api publiques stables de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de design d'api publiques stables, puis vérifiez le résultat attendu.
...
Version complète: `docs/book/chapters/39-design-api-publiques-stables.md`.
