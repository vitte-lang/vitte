 ...
 */
export declare const KEYWORDS: readonly ["module", "import", "pub", "struct", "enum", "union", "type", "fn", "let", "mut", "const", "static", "as", "where", "if", "else", "while", "for", "in", "loop", "match", "break", "continue", "return"];
...
export declare const NIL_LITERALS: readonly ["nil"];
export type BoolLiteral = typeof BOOL_LITERALS[number];
export type NilLiteral = typeof NIL_LITERALS[number];
export declare const PRIMITIVE_TYPES: readonly ["bool", "char", "str", "void", "i8", "i16", "i32", "i64", "isize", "u8", "u16", "u32", "u64", "usize", "f32", "f64"];
...
export declare const LanguageFacts: {
    readonly KEYWORDS: readonly ["module", "import", "pub", "struct", "enum", "union", "type", "fn", "let", "mut", "const", "static", "as", "where", "if", "else", "while", "for", "in", "loop", "match", "break", "continue", "return"];
    readonly CONTEXTUAL_KEYWORDS: readonly [];
    readonly BOOL_LITERALS: readonly ["true", "false"];
    readonly NIL_LITERALS: readonly ["nil"];
    readonly PRIMITIVE_TYPES: readonly ["bool", "char", "str", "void", "i8", "i16", "i32", "i64", "isize", "u8", "u16", "u32", "u64", "usize", "f32", "f64"];
