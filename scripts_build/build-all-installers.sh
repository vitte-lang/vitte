...
run 'FreeBSD pkg: amd64, arm64' all "$ROOT_DIR/scripts_build/build-freebsd-packages.sh"
...
run 'Solaris SVR4: amd64' amd64 "$ROOT_DIR/scripts_build/build-solaris-package.sh"
