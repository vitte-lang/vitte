#!/usr/bin/env bash
# ============================================================
# vitte — target definition: linux-x86_64
# Location: toolchain/scripts/targets/linux-x86_64.sh
# ============================================================
...
# Target identity
# ----------------------------
export VITTE_TARGET_NAME="linux-x86_64"
export VITTE_TARGET_OS="linux"
export VITTE_TARGET_ARCH="x86_64"
export VITTE_TARGET_TRIPLE="x86_64-unknown-linux-gnu"
...
# Cross-build: set LINUX_X86_64_SYSROOT to your sysroot path
export SYSROOT="${LINUX_X86_64_SYSROOT:-}"
SYSROOT_FLAGS=()
if [ -n "$SYSROOT" ]; then
