...
mkdir -p "$STAGE_ROOT/usr/local/share/vitte/assets"
mkdir -p "$STAGE_ROOT/usr/local/share/vitte/examples"
...
rsync -a --exclude='.DS_Store' --exclude='._*' "$ROOT_DIR/assets/" "$STAGE_ROOT/usr/local/share/vitte/assets/"
rsync -a "$ROOT_DIR/examples/" "$STAGE_ROOT/usr/local/share/vitte/examples/"
rsync -a "$ROOT_DIR/locales/" "$STAGE_ROOT/usr/local/share/vitte/locales/"
