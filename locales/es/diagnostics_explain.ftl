...
E0013.summary = proc puede salir sin devolver un valor.
...
E_CLI_IO.summary = The compiler cannot read the requested entrada archivo.
...
E_CLI_MISSING_ARG.summary = command argumento faltante.
...
E_CLI_UNKNOWN_COMMAND.summary = compiler command desconocido.
...
E_CLI_UNKNOWN_OPTION.summary = compiler option desconocido.
...
E_IO_FILE_NOT_FOUND.summary = entrada archivo faltante.
...
E_IO_FILE_UNREADABLE.summary = entrada archivo is not readable.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot escritura salida archivo.
...
E_IO_DIRECTORY_NOT_FOUND.summary = salida directory faltante.
...
E_IO_OVERWRITE_FORBIDDEN.summary = refusing to overwrite existing salida.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline fallido.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was faltante.
...
LINK_E_COMMAND_FAILED.summary = linker command fallido.
...
PARSE_E_OLD_VITTE_SYNTAX.summary = old Vitte sintaxis is not canonical.
...
AST_E_UNKNOWN_FIELD.summary = form campo desconocido.
...
AST_E_MISSING_FIELD.summary = form campo faltante.
...
AST_E_FIELD_TYPE_MISMATCH.summary = form campo tipo incompatibilidad.
...
TYPECK_E_PICK_NON_EXHAUSTIVE.summary = pick patron is not exhaustive.
...
TYPECK_E_IMPOSSIBLE_PATTERN.summary = pick patron can never match.
...
TYPECK_E_MISSING_GIVE.summary = give in valor procedure faltante.
...
TYPECK_E_CONTROL_PATH_MISSING_GIVE.summary = control ruta reaches end without give.
...
TYPECK_W_UNREACHABLE_AFTER_GIVE.summary = code after give is inalcanzable.
...
TYPECK_E_IMMUTABLE_ASSIGN.summary = cannot assign to immutable enlace.
...
TYPECK_W_MUTABLE_NEVER_MODIFIED.summary = mutable enlace is never changed.
...
TYPECK_E_MISSING_INITIALIZER.summary = let enlace requires an initializer or tipo.
...
TYPECK_E_INFERENCE_FAILED.summary = enlace tipo could not be inferred.
...
TYPECK_E_INVALID_CALL_TARGET.summary = llamada destino is not callable.
...
TYPECK_E_ARGUMENT_ORDER.summary = llamada argumentos are in the wrong order.
...
TYPECK_E_AMBIGUOUS_CALL.summary = procedure llamada is ambiguous.
...
TYPECK_E_IMPL_MISSING_MEMBER.summary = implementation is faltante a required miembro.
...
TYPECK_E_IMPL_SIGNATURE_MISMATCH.summary = implementation miembro signature does not match.
...
BORROWCK_E_MUTABLE_SHARED_CONFLICT.summary = mutable and compartido borrows overlap.
...
DRIVER_E_MISSING_COMMAND.summary = compiler command faltante.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = compiler option valor faltante.
...
DRIVER_E_SOURCE_UNREADABLE.summary = or unreadable entrada fuente faltante.
...
DRIVER_E_MISSING_TARGET.summary = compiler destino faltante.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = compiler salida directory faltante.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = compiler salida ruta faltante.
...
E_BOOTSTRAP_SPACE.summary = bootstrap space declaracion is invalido.
...
E_BOOTSTRAP_TOP_LEVEL.summary = bootstrap top-level declaracion is invalido.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command fallido.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command fallido.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package importacion test fallido.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is faltante.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package fuente archivo is faltante.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check fallido.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package importacion check fallido.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check fallido.
...
SYNTAX_E_INVALID_CALL.summary = llamada destino is not callable.
...
NAME_E_INVALID_CALL.summary = llamada destino is not callable.
...
MODULE_E_INVALID_CALL.summary = llamada destino is not callable.
...
TYPE_E_INVALID_CALL.summary = llamada destino is not callable.
...
GENERIC_E_INVALID_CALL.summary = llamada destino is not callable.
...
TRAIT_E_INVALID_CALL.summary = llamada destino is not callable.
...
OWNERSHIP_E_INVALID_CALL.summary = llamada destino is not callable.
...
LIFETIME_E_INVALID_CALL.summary = llamada destino is not callable.
...
CONST_E_INVALID_CALL.summary = llamada destino is not callable.
...
MACRO_E_INVALID_CALL.summary = llamada destino is not callable.
...
HIR_E_INVALID_CALL.summary = llamada destino is not callable.
...
MIR_E_INVALID_CALL.summary = llamada destino is not callable.
...
IR_E_INVALID_CALL.summary = llamada destino is not callable.
...
BACKEND_E_INVALID_CALL.summary = llamada destino is not callable.
...
LINK_E_INVALID_CALL.summary = llamada destino is not callable.
...
RUNTIME_E_INVALID_CALL.summary = llamada destino is not callable.
...
DRIVER_E_INVALID_CALL.summary = llamada destino is not callable.
...
LIMIT_E_INVALID_CALL.summary = llamada destino is not callable.
