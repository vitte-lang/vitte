...
E_CLI_IO.summary = The compiler cannot read the requested girdi dosya.
...
E_CLI_MISSING_ARG.summary = eksik command arguman.
...
E_CLI_UNKNOWN_COMMAND.summary = bilinmeyen compiler command.
...
E_CLI_UNKNOWN_OPTION.summary = bilinmeyen compiler option.
...
E_CLI_INVALID_ARGUMENT.summary = gecersiz compiler arguman.
...
E_IO_FILE_NOT_FOUND.summary = girdi dosya eksik.
...
E_IO_FILE_UNREADABLE.summary = girdi dosya is not readable.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot yazma cikti dosya.
...
E_IO_DIRECTORY_NOT_FOUND.summary = cikti directory eksik.
...
E_IO_OVERWRITE_FORBIDDEN.summary = refusing to overwrite existing cikti.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline basarisiz.
...
DRIVER_E_ANALYSIS_INVALID.summary = analysis gecersiz.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = kod uretimi ir incomplete.
...
DRIVER_E_FRONTEND_INPUT_NOT_LOADED.summary = frontend girdi not loaded.
...
DRIVER_E_FRONTEND_INVALID.summary = frontend gecersiz.
...
DRIVER_E_INVALID_LINK_PROFILE.summary = gecersiz link profil.
...
DRIVER_E_IR_INVALID.summary = ir gecersiz.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link kod uretimi incomplete.
...
DRIVER_E_MIR_ANALYSIS_INVALID.summary = mir analysis gecersiz.
...
DRIVER_E_MIR_INVALID.summary = mir gecersiz.
...
DRIVER_E_NO_INPUT.summary = no girdi.
...
DRIVER_E_PARSE_EMPTY_AST.summary = parse bos ast.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse bos kaynak.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process basarisiz.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was eksik.
...
LINK_E_COMMAND_FAILED.summary = linker command basarisiz.
...
DRIVER_E_MISSING_COMMAND.summary = eksik compiler command.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = eksik compiler option deger.
...
DRIVER_E_SOURCE_UNREADABLE.summary = eksik or unreadable girdi kaynak.
...
DRIVER_E_INVALID_CONFIGURATION.summary = gecersiz compiler configuration.
...
DRIVER_E_MISSING_TARGET.summary = eksik compiler hedef.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = eksik compiler cikti directory.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = eksik compiler cikti yol.
...
DRIVER_E_INVALID_LINK_TARGET.summary = gecersiz compiler link hedef.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command basarisiz.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command basarisiz.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package ice aktarma test basarisiz.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is eksik.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package kaynak dosya is eksik.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check basarisiz.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package ice aktarma check basarisiz.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check basarisiz.
