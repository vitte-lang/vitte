...
E0005.summary = A blok was opened but not closed with 'son' or '.son'.
...
E0013.summary = A procedure with an explicit donus tur has a yol that reaches the son without returning a deger.
...
E1023.summary = share references bilinmeyen sembol.
...
LEX_E_UNEXPECTED_EOF.summary = beklenmeyen son of dosya.
