...
E_CLI_IO.summary = The compiler cannot read the requested 入力 ファイル.
...
E_CLI_MISSING_ARG.summary = command 引数が欠落しています.
...
E_CLI_UNKNOWN_COMMAND.summary = 不明なcompiler command.
...
E_CLI_UNKNOWN_OPTION.summary = 不明なcompiler option.
...
E_CLI_INVALID_ARGUMENT.summary = compiler 引数が無効です.
...
E_IO_FILE_NOT_FOUND.summary = 入力 ファイル欠落.
...
E_IO_FILE_UNREADABLE.summary = 入力 ファイル is not readable.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot 書き込み 出力 ファイル.
...
E_IO_DIRECTORY_NOT_FOUND.summary = 出力 directory欠落.
...
E_IO_OVERWRITE_FORBIDDEN.summary = refusing to overwrite existing 出力.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline失敗.
...
DRIVER_E_ANALYSIS_INVALID.summary = analysis 無効.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = コード生成 ir incomplete.
...
DRIVER_E_FRONTEND_INPUT_NOT_LOADED.summary = frontend 入力 not loaded.
...
DRIVER_E_FRONTEND_INVALID.summary = frontend 無効.
...
DRIVER_E_INVALID_LINK_PROFILE.summary = link プロファイルが無効です.
...
DRIVER_E_IR_INVALID.summary = ir 無効.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link コード生成 incomplete.
...
DRIVER_E_MIR_ANALYSIS_INVALID.summary = mir analysis 無効.
...
DRIVER_E_MIR_INVALID.summary = mir 無効.
...
DRIVER_E_NO_INPUT.summary = no 入力.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse 空 ソース.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process失敗.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was欠落.
...
LINK_E_COMMAND_FAILED.summary = linker command失敗.
...
IR_E_INVALID_FUNCTION.summary = procedureが無効です.
...
DRIVER_E_MISSING_COMMAND.summary = compiler commandが欠落しています.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = compiler option 値が欠落しています.
...
DRIVER_E_SOURCE_UNREADABLE.summary = or unreadable 入力 ソースが欠落しています.
...
DRIVER_E_INVALID_CONFIGURATION.summary = compiler configurationが無効です.
...
DRIVER_E_MISSING_TARGET.summary = compiler 対象が欠落しています.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = compiler 出力 directoryが欠落しています.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = compiler 出力 パスが欠落しています.
...
DRIVER_E_INVALID_LINK_TARGET.summary = compiler link 対象が無効です.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command失敗.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command失敗.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package インポート test失敗.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is 欠落.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package ソース ファイル is 欠落.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check失敗.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package インポート check失敗.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check失敗.
