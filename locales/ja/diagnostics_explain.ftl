...
E0005.summary = A ブロック was opened but not closed with '終了' or '.終了'.
...
E0013.summary = A procedure with an explicit 戻り 型 has a パス that reaches the 終了 without returning a 値.
...
E1023.summary = share references 不明 シンボル.
...
LEX_E_UNEXPECTED_EOF.summary = 予期しない終了 of ファイル.
