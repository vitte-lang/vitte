...
E0013.summary = la procedure peut se terminer sans retourner de valeur.
...
DRIVER_E_ANALYSIS_INVALID.summary = analysis invalide.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = generation de code ir incomplete.
...
DRIVER_E_FRONTEND_INPUT_NOT_LOADED.summary = frontend entree not loaded.
...
DRIVER_E_FRONTEND_INVALID.summary = frontend invalide.
...
DRIVER_E_INVALID_LINK_PROFILE.summary = link profil invalide.
...
DRIVER_E_IR_INVALID.summary = ir invalide.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link generation de code incomplete.
...
DRIVER_E_MIR_ANALYSIS_INVALID.summary = mir analysis invalide.
...
DRIVER_E_MIR_INVALID.summary = mir invalide.
...
DRIVER_E_NO_INPUT.summary = no entree.
...
DRIVER_E_PARSE_EMPTY_AST.summary = parse vide ast.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse vide source.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process echec.
...
PARSE_E_OLD_VITTE_SYNTAX.summary = old Vitte syntaxe is not canonical.
...
AST_E_UNKNOWN_FIELD.summary = form champ inconnu.
...
AST_E_MISSING_FIELD.summary = form champ manquant.
...
AST_E_FIELD_TYPE_MISMATCH.summary = form champ type incompatibilite.
...
TYPECK_E_PICK_NON_EXHAUSTIVE.summary = pick motif is not exhaustive.
...
TYPECK_E_IMPOSSIBLE_PATTERN.summary = pick motif can never match.
...
TYPECK_E_MISSING_GIVE.summary = give in valeur procedure manquant.
...
TYPECK_E_GIVE_IN_VOID_PROC.summary = give valeur in procedure without retour type.
...
TYPECK_E_CONTROL_PATH_MISSING_GIVE.summary = control chemin reaches end without give.
...
TYPECK_W_UNREACHABLE_AFTER_GIVE.summary = code after give is inatteignable.
...
TYPECK_E_IMMUTABLE_ASSIGN.summary = cannot assign to immutable liaison.
...
TYPECK_W_MUTABLE_NEVER_MODIFIED.summary = mutable liaison is never changed.
...
TYPECK_E_REASSIGNMENT_FORBIDDEN.summary = cible cannot be reassigned.
...
TYPECK_E_MISSING_INITIALIZER.summary = let liaison requires an initializer or type.
...
TYPECK_E_INFERENCE_FAILED.summary = liaison type could not be inferred.
...
TYPECK_E_INVALID_CALL_TARGET.summary = appel cible is not callable.
...
TYPECK_E_ARGUMENT_ORDER.summary = appel arguments are in the wrong order.
...
TYPECK_E_AMBIGUOUS_CALL.summary = procedure appel is ambiguous.
...
TYPECK_E_NOT_CALLABLE.summary = valeur is not callable.
...
TYPECK_E_IMPL_MISSING_MEMBER.summary = implementation is manquant a required membre.
...
TYPECK_E_IMPL_SIGNATURE_MISMATCH.summary = implementation membre signature does not match.
...
BORROWCK_E_PARTIAL_MOVE.summary = valeur partially deplace.
...
BORROWCK_E_MUTABLE_SHARED_CONFLICT.summary = mutable and partage borrows overlap.
...
BORROWCK_E_REFERENCE_OUTLIVES_VALUE.summary = reference outlives the valeur it points to.
...
IR_E_INVALID_FUNCTION.summary = procedure invalide.
...
DRIVER_E_MISSING_COMMAND.summary = compiler command manquant.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = compiler option valeur manquant.
...
DRIVER_E_SOURCE_UNREADABLE.summary = or unreadable entree source manquant.
...
DRIVER_E_INVALID_CONFIGURATION.summary = compiler configuration invalide.
...
DRIVER_E_MISSING_TARGET.summary = compiler cible manquant.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = compiler sortie directory manquant.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = compiler sortie chemin manquant.
...
DRIVER_E_INVALID_LINK_TARGET.summary = compiler link cible invalide.
...
E_BOOTSTRAP_BANNER.summary = bootstrap banner is invalide.
...
E_BOOTSTRAP_CONST_SIGNATURE.summary = bootstrap constante signature is invalide.
...
E_BOOTSTRAP_EXPORT.summary = bootstrap export is invalide.
...
E_BOOTSTRAP_MAIN_BODY.summary = bootstrap main body is invalide.
...
E_BOOTSTRAP_MAIN_SIGNATURE.summary = bootstrap main signature is invalide.
...
E_BOOTSTRAP_PROC_BODY.summary = bootstrap procedure body is invalide.
...
E_BOOTSTRAP_PROC_SIGNATURE.summary = bootstrap procedure signature is invalide.
...
E_BOOTSTRAP_SPACE.summary = bootstrap space declaration is invalide.
...
E_BOOTSTRAP_TOP_LEVEL.summary = bootstrap top-level declaration is invalide.
...
E_BOOTSTRAP_VERSION.summary = bootstrap version is invalide.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command echec.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command echec.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package import test echec.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is manquant.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package source fichier is manquant.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check echec.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package import check echec.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check echec.
...
SYNTAX_E_INVALID_CALL.summary = appel cible is not callable.
...
NAME_E_INVALID_CALL.summary = appel cible is not callable.
...
MODULE_E_INVALID_CALL.summary = appel cible is not callable.
...
TYPE_E_INVALID_CALL.summary = appel cible is not callable.
...
GENERIC_E_INVALID_CALL.summary = appel cible is not callable.
...
TRAIT_E_INVALID_CALL.summary = appel cible is not callable.
...
OWNERSHIP_E_INVALID_CALL.summary = appel cible is not callable.
...
LIFETIME_E_INVALID_CALL.summary = appel cible is not callable.
...
CONST_E_INVALID_CALL.summary = appel cible is not callable.
...
MACRO_E_INVALID_CALL.summary = appel cible is not callable.
...
HIR_E_INVALID_CALL.summary = appel cible is not callable.
...
MIR_E_INVALID_CALL.summary = appel cible is not callable.
...
IR_E_INVALID_CALL.summary = appel cible is not callable.
...
BACKEND_E_INVALID_CALL.summary = appel cible is not callable.
...
LINK_E_INVALID_CALL.summary = appel cible is not callable.
...
RUNTIME_E_INVALID_CALL.summary = appel cible is not callable.
...
DRIVER_E_INVALID_CALL.summary = appel cible is not callable.
...
LIMIT_E_INVALID_CALL.summary = appel cible is not callable.
