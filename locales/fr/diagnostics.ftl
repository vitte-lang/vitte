...
LEX_E_INVALID_NUMBER = litteral numerique invalide
LEX_E_INVALID_ESCAPE = sequence d'echappement invalide
LEX_E_INVALID_UNICODE_ESCAPE = sequence d'echappement unicode invalide
LEX_E_INVALID_UTF8 = sequence d'octets UTF-8 invalide
LEX_E_INVALID_CHAR_LITERAL = litteral caractere invalide
LEX_E_INVALID_IDENTIFIER = identifiant invalide
LEX_E_UNTERMINATED_STRING = chaine non terminee
LEX_E_UNTERMINATED_CHAR = caractere non termine
LEX_E_UNTERMINATED_BLOCK_COMMENT = commentaire bloc non termine
LEX_E_UNTERMINATED_REGION_COMMENT = commentaire region non termine
LEX_E_UNEXPECTED_EOF = fin de fichier inattendue
LEX_E_TOKEN_TOO_LARGE = jeton trop grand
PLOOP = le parseur ne progresse plus
PPRIMARY999 = jeton d'expression inattendu
PSTMT007 = operateur d'affectation attendu
P0001 = jeton de niveau superieur inattendu
P000_UNBALANCED = bloc non referme
