...
DRIVER_E_ANALYSIS_INVALID = analysis invalid
DRIVER_E_BORROWCK_NOT_EXECUTED = borrowck not executed
DRIVER_E_CODEGEN_IR_INCOMPLETE = codegen ir incomplete
DRIVER_E_FRONTEND_INPUT_NOT_LOADED = frontend input not loaded
DRIVER_E_FRONTEND_INVALID = frontend invalid
DRIVER_E_INVALID_LINK_PROFILE = invalid link profile
DRIVER_E_IR_INVALID = ir invalid
DRIVER_E_IR_MIR_INCOMPLETE = ir mir incomplete
DRIVER_E_LINK_CODEGEN_INCOMPLETE = link codegen incomplete
DRIVER_E_MIR_ANALYSIS_INCOMPLETE = mir analysis incomplete
DRIVER_E_MIR_ANALYSIS_INVALID = mir analysis invalid
DRIVER_E_MIR_INVALID = mir invalid
DRIVER_E_NO_INPUT = no input
DRIVER_E_PARSE_EMPTY_AST = parse empty ast
DRIVER_E_PARSE_EMPTY_SOURCE = parse empty source
DRIVER_E_RUN_LINK_INCOMPLETE = run link incomplete
DRIVER_E_RUN_PROCESS_FAILED = run process failed
...
IR_E_INVALID_FUNCTION = invalid procedure
...
SYNTAX_E_INVALID_CALL = call target is not callable
...
NAME_E_INVALID_CALL = call target is not callable
...
MODULE_E_INVALID_CALL = call target is not callable
...
TYPE_E_INVALID_CALL = call target is not callable
...
GENERIC_E_INVALID_CALL = call target is not callable
...
TRAIT_E_INVALID_CALL = call target is not callable
...
OWNERSHIP_E_INVALID_CALL = call target is not callable
...
LIFETIME_E_INVALID_CALL = call target is not callable
...
CONST_E_INVALID_CALL = call target is not callable
...
MACRO_E_INVALID_CALL = call target is not callable
...
HIR_E_INVALID_CALL = call target is not callable
...
MIR_E_INVALID_CALL = call target is not callable
...
IR_E_INVALID_CALL = call target is not callable
...
BACKEND_E_INVALID_CALL = call target is not callable
...
LINK_E_INVALID_CALL = call target is not callable
...
RUNTIME_E_INVALID_CALL = call target is not callable
...
DRIVER_E_INVALID_CALL = call target is not callable
...
LIMIT_E_INVALID_CALL = call target is not callable
