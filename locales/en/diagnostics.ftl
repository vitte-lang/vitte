...
TYPECK_E_IMPL_UNKNOWN_TRAIT = implementation references an unknown trait
TYPECK_E_IMPL_MISSING_MEMBER = implementation is missing a required trait method
TYPECK_E_IMPL_SIGNATURE_MISMATCH = implementation method signature does not match the trait
