...
E_CLI_IO.summary = The compiler cannot read the requested input file.
...
E_CLI_MISSING_ARG.summary = missing command argument.
...
E_CLI_UNKNOWN_COMMAND.summary = unknown compiler command.
...
E_CLI_UNKNOWN_OPTION.summary = unknown compiler option.
...
E_CLI_INVALID_ARGUMENT.summary = invalid compiler argument.
...
E_IO_FILE_NOT_FOUND.summary = input file not found.
...
E_IO_FILE_UNREADABLE.summary = input file is not readable.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot write output file.
...
E_IO_DIRECTORY_NOT_FOUND.summary = output directory not found.
...
E_IO_OVERWRITE_FORBIDDEN.summary = refusing to overwrite existing output.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline failed.
...
DRIVER_E_ANALYSIS_INVALID.summary = analysis invalid.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = codegen ir incomplete.
...
DRIVER_E_FRONTEND_INPUT_NOT_LOADED.summary = frontend input not loaded.
...
DRIVER_E_FRONTEND_INVALID.summary = frontend invalid.
...
DRIVER_E_INVALID_LINK_PROFILE.summary = invalid link profile.
...
DRIVER_E_IR_INVALID.summary = ir invalid.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link codegen incomplete.
...
DRIVER_E_MIR_ANALYSIS_INVALID.summary = mir analysis invalid.
...
DRIVER_E_MIR_INVALID.summary = mir invalid.
...
DRIVER_E_NO_INPUT.summary = no input.
...
DRIVER_E_PARSE_EMPTY_AST.summary = parse empty ast.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse empty source.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process failed.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was not found.
...
LINK_E_COMMAND_FAILED.summary = linker command failed.
...
TYPECK_E_INVALID_CALL_TARGET.summary = call target is not callable.
...
TYPECK_E_ARGUMENT_ORDER.summary = call arguments are in the wrong order.
...
TYPECK_E_AMBIGUOUS_CALL.summary = procedure call is ambiguous.
...
TYPECK_E_NOT_CALLABLE.summary = value is not callable.
...
TYPECK_E_IMPL_MISSING_MEMBER.summary = implementation is missing a required member.
...
BORROWCK_E_PARTIAL_MOVE.summary = value partially moved.
...
BORROWCK_E_MUTABLE_SHARED_CONFLICT.summary = mutable and shared borrows overlap.
...
BORROWCK_E_REFERENCE_OUTLIVES_VALUE.summary = reference outlives the value it points to.
...
IR_E_INVALID_FUNCTION.summary = invalid procedure.
...
DRIVER_E_MISSING_COMMAND.summary = missing compiler command.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = missing compiler option value.
...
DRIVER_E_SOURCE_UNREADABLE.summary = missing or unreadable input source.
...
DRIVER_E_INVALID_CONFIGURATION.summary = invalid compiler configuration.
...
DRIVER_E_MISSING_TARGET.summary = missing compiler target.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = missing compiler output directory.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = missing compiler output path.
...
DRIVER_E_INVALID_LINK_TARGET.summary = invalid compiler link target.
...
E_BOOTSTRAP_BANNER.summary = bootstrap banner is invalid.
...
E_BOOTSTRAP_CONST_SIGNATURE.summary = bootstrap constant signature is invalid.
...
E_BOOTSTRAP_EXPORT.summary = bootstrap export is invalid.
...
E_BOOTSTRAP_MAIN_BODY.summary = bootstrap main body is invalid.
...
E_BOOTSTRAP_MAIN_SIGNATURE.summary = bootstrap main signature is invalid.
...
E_BOOTSTRAP_PROC_BODY.summary = bootstrap procedure body is invalid.
...
E_BOOTSTRAP_PROC_SIGNATURE.summary = bootstrap procedure signature is invalid.
...
E_BOOTSTRAP_SPACE.summary = bootstrap space declaration is invalid.
...
E_BOOTSTRAP_TOP_LEVEL.summary = bootstrap top-level declaration is invalid.
...
E_BOOTSTRAP_VERSION.summary = bootstrap version is invalid.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command failed.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command failed.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package import test failed.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is missing.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package source file is missing.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check failed.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package import check failed.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check failed.
...
SYNTAX_E_INVALID_CALL.summary = call target is not callable.
...
NAME_E_INVALID_CALL.summary = call target is not callable.
...
MODULE_E_INVALID_CALL.summary = call target is not callable.
...
TYPE_E_INVALID_CALL.summary = call target is not callable.
...
GENERIC_E_INVALID_CALL.summary = call target is not callable.
...
TRAIT_E_INVALID_CALL.summary = call target is not callable.
...
OWNERSHIP_E_INVALID_CALL.summary = call target is not callable.
...
LIFETIME_E_INVALID_CALL.summary = call target is not callable.
...
CONST_E_INVALID_CALL.summary = call target is not callable.
...
MACRO_E_INVALID_CALL.summary = call target is not callable.
...
HIR_E_INVALID_CALL.summary = call target is not callable.
...
MIR_E_INVALID_CALL.summary = call target is not callable.
...
IR_E_INVALID_CALL.summary = call target is not callable.
...
BACKEND_E_INVALID_CALL.summary = call target is not callable.
...
LINK_E_INVALID_CALL.summary = call target is not callable.
...
RUNTIME_E_INVALID_CALL.summary = call target is not callable.
...
DRIVER_E_INVALID_CALL.summary = call target is not callable.
...
LIMIT_E_INVALID_CALL.summary = call target is not callable.
