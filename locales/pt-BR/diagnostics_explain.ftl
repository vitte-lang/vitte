...
E0013.summary = proc pode terminar sem retornar um valor.
...
E_CLI_IO.summary = The compiler cannot read the requested entrada arquivo.
...
E_CLI_MISSING_ARG.summary = command argumento ausente.
...
E_CLI_UNKNOWN_COMMAND.summary = compiler command desconhecido.
...
E_CLI_UNKNOWN_OPTION.summary = compiler option desconhecido.
...
E_CLI_INVALID_ARGUMENT.summary = compiler argumento invalido.
...
E_IO_FILE_NOT_FOUND.summary = entrada arquivo ausente.
...
E_IO_FILE_UNREADABLE.summary = entrada arquivo is not readable.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot escrita saida arquivo.
...
E_IO_DIRECTORY_NOT_FOUND.summary = saida directory ausente.
...
E_IO_OVERWRITE_FORBIDDEN.summary = refusing to overwrite existing saida.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline falhou.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = geracao de codigo ir incomplete.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link geracao de codigo incomplete.
...
DRIVER_E_PARSE_EMPTY_AST.summary = parse vazio ast.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse vazio fonte.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process falhou.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was ausente.
...
LINK_E_COMMAND_FAILED.summary = linker command falhou.
...
PARSE_E_OLD_VITTE_SYNTAX.summary = old Vitte sintaxe is not canonical.
...
AST_E_UNKNOWN_FIELD.summary = form campo desconhecido.
...
AST_E_MISSING_FIELD.summary = form campo ausente.
...
AST_E_FIELD_TYPE_MISMATCH.summary = form campo tipo incompatibilidade.
...
TYPECK_E_PICK_NON_EXHAUSTIVE.summary = pick padrao is not exhaustive.
...
TYPECK_E_IMPOSSIBLE_PATTERN.summary = pick padrao can never match.
...
TYPECK_E_MISSING_GIVE.summary = give in valor procedure ausente.
...
TYPECK_E_GIVE_IN_VOID_PROC.summary = give valor in procedure without retorno tipo.
...
TYPECK_E_CONTROL_PATH_MISSING_GIVE.summary = control caminho reaches end without give.
...
TYPECK_W_UNREACHABLE_AFTER_GIVE.summary = code after give is inalcancavel.
...
TYPECK_E_IMMUTABLE_ASSIGN.summary = cannot assign to immutable vinculo.
...
TYPECK_W_MUTABLE_NEVER_MODIFIED.summary = mutavel vinculo is never changed.
...
TYPECK_E_REASSIGNMENT_FORBIDDEN.summary = destino cannot be reassigned.
...
TYPECK_E_MISSING_INITIALIZER.summary = let vinculo requires an initializer or tipo.
...
TYPECK_E_INFERENCE_FAILED.summary = vinculo tipo could not be inferred.
...
TYPECK_E_INVALID_CALL_TARGET.summary = chamada destino is not callable.
...
TYPECK_E_UNKNOWN_NAMED_ARGUMENT.summary = named argumento has no matching parameter.
...
TYPECK_E_ARGUMENT_ORDER.summary = chamada argumentos are in the wrong order.
...
TYPECK_E_AMBIGUOUS_CALL.summary = procedure chamada is ambiguous.
...
TYPECK_E_NOT_CALLABLE.summary = valor is not callable.
...
TYPECK_E_IMPL_MISSING_MEMBER.summary = implementation is ausente a required membro.
...
BORROWCK_E_PARTIAL_MOVE.summary = valor partially movido.
...
BORROWCK_E_MUTABLE_SHARED_CONFLICT.summary = mutavel and compartilhado borrows overlap.
...
BORROWCK_E_REFERENCE_OUTLIVES_VALUE.summary = referencia outlives the valor it points to.
...
IR_E_INVALID_FUNCTION.summary = procedure invalido.
...
DRIVER_E_MISSING_COMMAND.summary = compiler command ausente.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = compiler option valor ausente.
...
DRIVER_E_SOURCE_UNREADABLE.summary = or unreadable entrada fonte ausente.
...
DRIVER_E_INVALID_CONFIGURATION.summary = compiler configuration invalido.
...
DRIVER_E_MISSING_TARGET.summary = compiler destino ausente.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = compiler saida directory ausente.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = compiler saida caminho ausente.
...
DRIVER_E_INVALID_LINK_TARGET.summary = compiler link destino invalido.
...
E_BOOTSTRAP_BANNER.summary = bootstrap banner is invalido.
...
E_BOOTSTRAP_CONST_SIGNATURE.summary = bootstrap constante signature is invalido.
...
E_BOOTSTRAP_EXPORT.summary = bootstrap export is invalido.
...
E_BOOTSTRAP_MAIN_BODY.summary = bootstrap main body is invalido.
...
E_BOOTSTRAP_MAIN_SIGNATURE.summary = bootstrap main signature is invalido.
...
E_BOOTSTRAP_PROC_BODY.summary = bootstrap procedure body is invalido.
...
E_BOOTSTRAP_PROC_SIGNATURE.summary = bootstrap procedure signature is invalido.
...
E_BOOTSTRAP_SPACE.summary = bootstrap space declaracao is invalido.
...
E_BOOTSTRAP_TOP_LEVEL.summary = bootstrap top-level declaracao is invalido.
...
E_BOOTSTRAP_VERSION.summary = bootstrap version is invalido.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command falhou.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command falhou.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package importacao test falhou.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is ausente.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package fonte arquivo is ausente.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check falhou.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package importacao check falhou.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check falhou.
...
SYNTAX_E_INVALID_CALL.summary = chamada destino is not callable.
...
NAME_E_INVALID_CALL.summary = chamada destino is not callable.
...
MODULE_E_INVALID_CALL.summary = chamada destino is not callable.
...
TYPE_E_INVALID_CALL.summary = chamada destino is not callable.
...
GENERIC_E_INVALID_CALL.summary = chamada destino is not callable.
...
TRAIT_E_INVALID_CALL.summary = chamada destino is not callable.
...
OWNERSHIP_E_INVALID_CALL.summary = chamada destino is not callable.
...
LIFETIME_E_INVALID_CALL.summary = chamada destino is not callable.
...
CONST_E_INVALID_CALL.summary = chamada destino is not callable.
...
MACRO_E_INVALID_CALL.summary = chamada destino is not callable.
...
HIR_E_INVALID_CALL.summary = chamada destino is not callable.
...
MIR_E_INVALID_CALL.summary = chamada destino is not callable.
...
IR_E_INVALID_CALL.summary = chamada destino is not callable.
...
BACKEND_E_INVALID_CALL.summary = chamada destino is not callable.
...
LINK_E_INVALID_CALL.summary = chamada destino is not callable.
...
RUNTIME_E_INVALID_CALL.summary = chamada destino is not callable.
...
DRIVER_E_INVALID_CALL.summary = chamada destino is not callable.
...
LIMIT_E_INVALID_CALL.summary = chamada destino is not callable.
