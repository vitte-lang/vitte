...
E1023.summary = share posylaietsia na nevidomyi symvol.
...
LEX_E_UNEXPECTED_EOF.summary = end of fail neochikuvanyi.
...
E_CLI_IO.summary = The compiler cannot read the requested vkhid fail.
...
E_CLI_MISSING_ARG.summary = command argument vidsutnii.
...
E_CLI_UNKNOWN_COMMAND.summary = compiler command nevidomyi.
...
E_CLI_UNKNOWN_OPTION.summary = compiler option nevidomyi.
...
E_CLI_INVALID_ARGUMENT.summary = compiler argument neprypustymyi.
...
E_IO_FILE_NOT_FOUND.summary = vkhid fail vidsutnii.
...
E_IO_FILE_UNREADABLE.summary = vkhid fail is not readable.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot zapys vykhid fail.
...
E_IO_DIRECTORY_NOT_FOUND.summary = vykhid directory vidsutnii.
...
E_IO_OVERWRITE_FORBIDDEN.summary = refusing to overwrite existing vykhid.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline zbi.
...
DRIVER_E_ANALYSIS_INVALID.summary = analysis neprypustymyi.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = heneratsiia kodu ir incomplete.
...
DRIVER_E_FRONTEND_INPUT_NOT_LOADED.summary = frontend vkhid not loaded.
...
DRIVER_E_FRONTEND_INVALID.summary = frontend neprypustymyi.
...
DRIVER_E_INVALID_LINK_PROFILE.summary = link profil neprypustymyi.
...
DRIVER_E_IR_INVALID.summary = ir neprypustymyi.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link heneratsiia kodu incomplete.
...
DRIVER_E_MIR_ANALYSIS_INVALID.summary = mir analysis neprypustymyi.
...
DRIVER_E_MIR_INVALID.summary = mir neprypustymyi.
...
DRIVER_E_NO_INPUT.summary = no vkhid.
...
DRIVER_E_PARSE_EMPTY_AST.summary = parse porozhnii ast.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse porozhnii dzherelo.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process zbi.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was vidsutnii.
...
LINK_E_COMMAND_FAILED.summary = linker command zbi.
...
LEX_E_INVALID_UNICODE.summary = unicode neprypustymyi.
...
LEX_E_UNTERMINATED_COMMENT.summary = comment ne zaversheno.
...
PARSE_E_TOPLEVEL_DECL_EXPECTED.summary = top-level oholoshennia expected.
...
PARSE_E_INCOMPLETE_EXPR.summary = incomplete vyraz.
...
PARSE_E_MISSING_RPAREN.summary = closing parenthesis vidsutnii.
...
PARSE_E_MISSING_COMMA.summary = comma vidsutnii.
...
PARSE_E_PATTERN_EXPECTED.summary = zrazok expected.
...
PARSE_E_UNCLOSED_BLOCK.summary = blok ne zakryto.
...
PARSE_E_OLD_VITTE_SYNTAX.summary = old Vitte syntaksys is not canonical.
...
AST_E_UNKNOWN_FIELD.summary = form pole nevidomyi.
...
AST_E_MISSING_FIELD.summary = form pole vidsutnii.
...
AST_E_FIELD_TYPE_MISMATCH.summary = form pole typ nevidpovidnist.
...
SEMA_E_UNKNOWN_IDENTIFIER.summary = identyfikator nevidomyi.
...
SEMA_E_AMBIGUOUS_SYMBOL.summary = ambiguous symvol.
...
TYPECK_E_PICK_NON_EXHAUSTIVE.summary = pick zrazok is not exhaustive.
...
TYPECK_E_IMPOSSIBLE_PATTERN.summary = pick zrazok can never match.
...
TYPECK_E_RETURN_MISMATCH.summary = povernennia typ nevidpovidnist.
...
TYPECK_E_MISSING_GIVE.summary = give in znachennia procedure vidsutnii.
...
TYPECK_E_GIVE_IN_VOID_PROC.summary = give znachennia in procedure without povernennia typ.
...
TYPECK_E_CONTROL_PATH_MISSING_GIVE.summary = control shliakh reaches end without give.
...
TYPECK_W_UNREACHABLE_AFTER_GIVE.summary = code after give is nedosiazhnyi.
...
TYPECK_E_IMMUTABLE_ASSIGN.summary = cannot assign to immutable pryviazka.
...
TYPECK_W_MUTABLE_NEVER_MODIFIED.summary = zminnyi pryviazka is never changed.
...
TYPECK_E_REASSIGNMENT_FORBIDDEN.summary = tsil cannot be reassigned.
...
TYPECK_E_MISSING_INITIALIZER.summary = let pryviazka requires an initializer or typ.
...
TYPECK_E_INFERENCE_FAILED.summary = pryviazka typ could not be inferred.
...
TYPECK_E_INVALID_CALL_TARGET.summary = vyklyk tsil is not callable.
...
TYPECK_E_ARGUMENT_ORDER.summary = vyklyk argumenty are in the wrong order.
...
TYPECK_E_AMBIGUOUS_CALL.summary = procedure vyklyk is ambiguous.
...
TYPECK_E_NOT_CALLABLE.summary = znachennia is not callable.
...
TYPECK_E_IMPL_MISSING_MEMBER.summary = implementation is vidsutnii a required chlen.
...
TYPECK_E_IMPL_SIGNATURE_MISMATCH.summary = implementation chlen signature does not match.
...
TYPECK_E_GENERIC_INFERENCE.summary = uzahalnenyi typ could not be inferred.
...
TYPECK_E_CAUSE_CHAIN_MISSING.summary = typ diagnostic is vidsutnii a cause chain.
...
TYPECK_E_CONSTRAINT_CYCLE.summary = cyclic uzahalnenyi constraint.
...
BORROWCK_E_PARTIAL_MOVE.summary = znachennia partially peremishchenyi.
...
BORROWCK_E_MUTABLE_SHARED_CONFLICT.summary = zminnyi and spilnyi borrows overlap.
...
BORROWCK_E_REFERENCE_OUTLIVES_VALUE.summary = posylannia outlives the znachennia it points to.
...
MOD_E_MODULE_NOT_FOUND.summary = modul vidsutnii.
...
MOD_E_IMPORT_CYCLE.summary = import tsykl detected.
...
MOD_E_SYMBOL_NOT_EXPORTED.summary = symvol is ne eksportovano modul.
...
MOD_E_IMPORT_NOT_FOUND.summary = import vidsutnii.
...
MOD_E_PACKAGE_MISSING.summary = package vidsutnii.
...
MOD_E_STDLIB_MISSING.summary = stdlib vidsutnii.
...
MOD_E_AMBIGUOUS_MODULE.summary = ambiguous modul shliakh.
...
IR_E_INVALID_FUNCTION.summary = procedure neprypustymyi.
...
DRIVER_E_MISSING_COMMAND.summary = compiler command vidsutnii.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = compiler option znachennia vidsutnii.
...
DRIVER_E_SOURCE_UNREADABLE.summary = or unreadable vkhid dzherelo vidsutnii.
...
DRIVER_E_INVALID_CONFIGURATION.summary = compiler configuration neprypustymyi.
...
DRIVER_E_MISSING_TARGET.summary = compiler tsil vidsutnii.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = compiler vykhid directory vidsutnii.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = compiler vykhid shliakh vidsutnii.
...
DRIVER_E_INVALID_LINK_TARGET.summary = compiler link tsil neprypustymyi.
...
E_BOOTSTRAP_BANNER.summary = bootstrap banner is neprypustymyi.
...
E_BOOTSTRAP_CONST_SIGNATURE.summary = bootstrap konstanta signature is neprypustymyi.
...
E_BOOTSTRAP_CONST_TYPE.summary = bootstrap konstanta has wrong typ.
...
E_BOOTSTRAP_EXPORT.summary = bootstrap export is neprypustymyi.
...
E_BOOTSTRAP_MAIN_BODY.summary = bootstrap main body is neprypustymyi.
...
E_BOOTSTRAP_MAIN_SIGNATURE.summary = bootstrap main signature is neprypustymyi.
...
E_BOOTSTRAP_PROC_BODY.summary = bootstrap procedure body is neprypustymyi.
...
E_BOOTSTRAP_PROC_SIGNATURE.summary = bootstrap procedure signature is neprypustymyi.
...
E_BOOTSTRAP_SPACE.summary = bootstrap space oholoshennia is neprypustymyi.
...
E_BOOTSTRAP_TOP_LEVEL.summary = bootstrap top-level oholoshennia is neprypustymyi.
...
E_BOOTSTRAP_UNKNOWN_CONST.summary = bootstrap konstanta nevidomyi.
...
E_BOOTSTRAP_UNKNOWN_PROC.summary = bootstrap procedure ne pidtrymuietsia.
...
E_BOOTSTRAP_VERSION.summary = bootstrap version is neprypustymyi.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command zbi.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command zbi.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package import test zbi.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is vidsutnii.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package dzherelo fail is vidsutnii.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check zbi.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package import check zbi.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check zbi.
...
SYNTAX_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
NAME_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
MODULE_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
TYPE_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
GENERIC_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
TRAIT_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
OWNERSHIP_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
LIFETIME_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
CONST_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
MACRO_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
HIR_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
MIR_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
IR_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
BACKEND_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
LINK_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
RUNTIME_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
DRIVER_E_INVALID_CALL.summary = vyklyk tsil is not callable.
...
LIMIT_E_INVALID_CALL.summary = vyklyk tsil is not callable.
