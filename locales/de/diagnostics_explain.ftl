...
E0005.summary = A Block was opened but not closed with 'Ende' or '.Ende'.
...
E0013.summary = A procedure with an explicit Rueckgabe Typ has a Pfad that reaches the Ende without returning a Wert.
...
E1023.summary = share references unbekannt Symbol.
...
LEX_E_UNEXPECTED_EOF.summary = Ende of Datei unerwartet.
