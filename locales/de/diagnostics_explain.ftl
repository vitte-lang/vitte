...
E_CLI_IO.summary = The compiler cannot read the requested Eingabe Datei.
...
E_CLI_MISSING_ARG.summary = command Argument fehlt.
...
E_CLI_UNKNOWN_COMMAND.summary = compiler command unbekannt.
...
E_CLI_UNKNOWN_OPTION.summary = compiler option unbekannt.
...
E_CLI_INVALID_ARGUMENT.summary = compiler Argument ungueltig.
...
E_IO_FILE_NOT_FOUND.summary = Eingabe Datei fehlend.
...
E_IO_FILE_UNREADABLE.summary = Eingabe Datei is not readable.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot Schreibzugriff Ausgabe Datei.
...
E_IO_DIRECTORY_NOT_FOUND.summary = Ausgabe directory fehlend.
...
E_IO_OVERWRITE_FORBIDDEN.summary = refusing to overwrite existing Ausgabe.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline fehlgeschlagen.
...
DRIVER_E_ANALYSIS_INVALID.summary = analysis ungueltig.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = Codeerzeugung ir incomplete.
...
DRIVER_E_FRONTEND_INPUT_NOT_LOADED.summary = frontend Eingabe not loaded.
...
DRIVER_E_FRONTEND_INVALID.summary = frontend ungueltig.
...
DRIVER_E_INVALID_LINK_PROFILE.summary = link Profil ungueltig.
...
DRIVER_E_IR_INVALID.summary = ir ungueltig.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link Codeerzeugung incomplete.
...
DRIVER_E_MIR_ANALYSIS_INVALID.summary = mir analysis ungueltig.
...
DRIVER_E_MIR_INVALID.summary = mir ungueltig.
...
DRIVER_E_NO_INPUT.summary = no Eingabe.
...
DRIVER_E_PARSE_EMPTY_AST.summary = parse leer ast.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse leer Quelle.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process fehlgeschlagen.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was fehlend.
...
LINK_E_COMMAND_FAILED.summary = linker command fehlgeschlagen.
...
PARSE_E_OLD_VITTE_SYNTAX.summary = old Vitte Syntax is not canonical.
...
TYPECK_E_PICK_NON_EXHAUSTIVE.summary = pick Muster is not exhaustive.
...
TYPECK_E_IMPOSSIBLE_PATTERN.summary = pick Muster can never match.
...
TYPECK_E_INVALID_CALL_TARGET.summary = Aufruf Ziel is not callable.
...
TYPECK_E_ARGUMENT_ORDER.summary = Aufruf Argumente are in the wrong order.
...
TYPECK_E_AMBIGUOUS_CALL.summary = procedure Aufruf is ambiguous.
...
TYPECK_E_NOT_CALLABLE.summary = Wert is not callable.
...
TYPECK_E_IMPL_MISSING_MEMBER.summary = implementation is fehlend a required Member.
...
TYPECK_E_IMPL_SIGNATURE_MISMATCH.summary = implementation Member signature does not match.
...
BORROWCK_E_PARTIAL_MOVE.summary = Wert partially verschoben.
...
BORROWCK_E_MUTABLE_SHARED_CONFLICT.summary = veraenderbar and geteilt borrows overlap.
...
BORROWCK_E_REFERENCE_OUTLIVES_VALUE.summary = Referenz outlives the Wert it points to.
...
IR_E_INVALID_FUNCTION.summary = procedure ungueltig.
...
DRIVER_E_MISSING_COMMAND.summary = compiler command fehlt.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = compiler option Wert fehlt.
...
DRIVER_E_SOURCE_UNREADABLE.summary = or unreadable Eingabe Quelle fehlt.
...
DRIVER_E_INVALID_CONFIGURATION.summary = compiler configuration ungueltig.
...
DRIVER_E_MISSING_TARGET.summary = compiler Ziel fehlt.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = compiler Ausgabe directory fehlt.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = compiler Ausgabe Pfad fehlt.
...
DRIVER_E_INVALID_LINK_TARGET.summary = compiler link Ziel ungueltig.
...
E_BOOTSTRAP_BANNER.summary = bootstrap banner is ungueltig.
...
E_BOOTSTRAP_CONST_SIGNATURE.summary = bootstrap Konstante signature is ungueltig.
...
E_BOOTSTRAP_EXPORT.summary = bootstrap export is ungueltig.
...
E_BOOTSTRAP_MAIN_BODY.summary = bootstrap main body is ungueltig.
...
E_BOOTSTRAP_MAIN_SIGNATURE.summary = bootstrap main signature is ungueltig.
...
E_BOOTSTRAP_PROC_BODY.summary = bootstrap procedure body is ungueltig.
...
E_BOOTSTRAP_PROC_SIGNATURE.summary = bootstrap procedure signature is ungueltig.
...
E_BOOTSTRAP_SPACE.summary = bootstrap space Deklaration is ungueltig.
...
E_BOOTSTRAP_TOP_LEVEL.summary = bootstrap top-level Deklaration is ungueltig.
...
E_BOOTSTRAP_VERSION.summary = bootstrap version is ungueltig.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command fehlgeschlagen.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command fehlgeschlagen.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package Import test fehlgeschlagen.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is fehlend.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package Quelle Datei is fehlend.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check fehlgeschlagen.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package Import check fehlgeschlagen.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check fehlgeschlagen.
...
SYNTAX_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
NAME_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
MODULE_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
TYPE_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
GENERIC_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
TRAIT_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
OWNERSHIP_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
LIFETIME_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
CONST_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
MACRO_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
HIR_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
MIR_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
IR_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
BACKEND_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
LINK_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
RUNTIME_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
DRIVER_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
...
LIMIT_E_INVALID_CALL.summary = Aufruf Ziel is not callable.
