...
E_CLI_IO.summary = The compiler cannot read the requested vvod fail.
...
E_CLI_MISSING_ARG.summary = command argument otsutstvuet.
...
E_CLI_UNKNOWN_COMMAND.summary = compiler command neizvestnyi.
...
E_CLI_UNKNOWN_OPTION.summary = compiler option neizvestnyi.
...
E_CLI_INVALID_ARGUMENT.summary = compiler argument nedopustimyi.
...
E_IO_FILE_NOT_FOUND.summary = vvod fail otsutstvuet.
...
E_IO_FILE_UNREADABLE.summary = vvod fail is not readable.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot zapis vyvod fail.
...
E_IO_DIRECTORY_NOT_FOUND.summary = vyvod directory otsutstvuet.
...
E_IO_OVERWRITE_FORBIDDEN.summary = refusing to overwrite existing vyvod.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline sboi.
...
DRIVER_E_ANALYSIS_INVALID.summary = analysis nedopustimyi.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = generatsiya koda ir incomplete.
...
DRIVER_E_FRONTEND_INPUT_NOT_LOADED.summary = frontend vvod not loaded.
...
DRIVER_E_FRONTEND_INVALID.summary = frontend nedopustimyi.
...
DRIVER_E_INVALID_LINK_PROFILE.summary = link profil nedopustimyi.
...
DRIVER_E_IR_INVALID.summary = ir nedopustimyi.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link generatsiya koda incomplete.
...
DRIVER_E_MIR_ANALYSIS_INVALID.summary = mir analysis nedopustimyi.
...
DRIVER_E_MIR_INVALID.summary = mir nedopustimyi.
...
DRIVER_E_NO_INPUT.summary = no vvod.
...
DRIVER_E_PARSE_EMPTY_AST.summary = parse pustoi ast.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse pustoi istochnik.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process sboi.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was otsutstvuet.
...
LINK_E_COMMAND_FAILED.summary = linker command sboi.
...
PARSE_E_OLD_VITTE_SYNTAX.summary = old Vitte sintaksis is not canonical.
...
AST_E_UNKNOWN_FIELD.summary = form pole neizvestnyi.
...
AST_E_MISSING_FIELD.summary = form pole otsutstvuet.
...
AST_E_FIELD_TYPE_MISMATCH.summary = form pole tip nesootvetstvie.
...
TYPECK_E_PICK_NON_EXHAUSTIVE.summary = pick shablon is not exhaustive.
...
TYPECK_E_IMPOSSIBLE_PATTERN.summary = pick shablon can never match.
...
TYPECK_E_MISSING_GIVE.summary = give in znachenie procedure otsutstvuet.
...
TYPECK_E_GIVE_IN_VOID_PROC.summary = give znachenie in procedure without vozvrat tip.
...
TYPECK_E_CONTROL_PATH_MISSING_GIVE.summary = control put reaches end without give.
...
TYPECK_W_UNREACHABLE_AFTER_GIVE.summary = code after give is nedostizhimyi.
...
TYPECK_E_IMMUTABLE_ASSIGN.summary = cannot assign to immutable privyazka.
...
TYPECK_W_MUTABLE_NEVER_MODIFIED.summary = izmenyaemyi privyazka is never changed.
...
TYPECK_E_REASSIGNMENT_FORBIDDEN.summary = tsel cannot be reassigned.
...
TYPECK_E_MISSING_INITIALIZER.summary = let privyazka requires an initializer or tip.
...
TYPECK_E_INFERENCE_FAILED.summary = privyazka tip could not be inferred.
...
TYPECK_E_INVALID_CALL_TARGET.summary = vyzov tsel is not callable.
...
TYPECK_E_ARGUMENT_ORDER.summary = vyzov argumenty are in the wrong order.
...
TYPECK_E_AMBIGUOUS_CALL.summary = procedure vyzov is ambiguous.
...
TYPECK_E_NOT_CALLABLE.summary = znachenie is not callable.
...
TYPECK_E_IMPL_MISSING_MEMBER.summary = implementation is otsutstvuet a required chlen.
...
BORROWCK_E_PARTIAL_MOVE.summary = znachenie partially peremeshchen.
...
BORROWCK_E_MUTABLE_SHARED_CONFLICT.summary = izmenyaemyi and obshchii borrows overlap.
...
BORROWCK_E_REFERENCE_OUTLIVES_VALUE.summary = ssylka outlives the znachenie it points to.
...
IR_E_INVALID_FUNCTION.summary = procedure nedopustimyi.
...
DRIVER_E_MISSING_COMMAND.summary = compiler command otsutstvuet.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = compiler option znachenie otsutstvuet.
...
DRIVER_E_SOURCE_UNREADABLE.summary = or unreadable vvod istochnik otsutstvuet.
...
DRIVER_E_INVALID_CONFIGURATION.summary = compiler configuration nedopustimyi.
...
DRIVER_E_MISSING_TARGET.summary = compiler tsel otsutstvuet.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = compiler vyvod directory otsutstvuet.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = compiler vyvod put otsutstvuet.
...
DRIVER_E_INVALID_LINK_TARGET.summary = compiler link tsel nedopustimyi.
...
E_BOOTSTRAP_BANNER.summary = bootstrap banner is nedopustimyi.
...
E_BOOTSTRAP_CONST_SIGNATURE.summary = bootstrap konstanta signature is nedopustimyi.
...
E_BOOTSTRAP_EXPORT.summary = bootstrap export is nedopustimyi.
...
E_BOOTSTRAP_MAIN_BODY.summary = bootstrap main body is nedopustimyi.
...
E_BOOTSTRAP_MAIN_SIGNATURE.summary = bootstrap main signature is nedopustimyi.
...
E_BOOTSTRAP_PROC_BODY.summary = bootstrap procedure body is nedopustimyi.
...
E_BOOTSTRAP_PROC_SIGNATURE.summary = bootstrap procedure signature is nedopustimyi.
...
E_BOOTSTRAP_SPACE.summary = bootstrap space obyavlenie is nedopustimyi.
...
E_BOOTSTRAP_TOP_LEVEL.summary = bootstrap top-level obyavlenie is nedopustimyi.
...
E_BOOTSTRAP_VERSION.summary = bootstrap version is nedopustimyi.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command sboi.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command sboi.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package import test sboi.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is otsutstvuet.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package istochnik fail is otsutstvuet.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check sboi.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package import check sboi.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check sboi.
...
SYNTAX_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
NAME_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
MODULE_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
TYPE_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
GENERIC_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
TRAIT_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
OWNERSHIP_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
LIFETIME_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
CONST_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
MACRO_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
HIR_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
MIR_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
IR_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
BACKEND_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
LINK_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
RUNTIME_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
DRIVER_E_INVALID_CALL.summary = vyzov tsel is not callable.
...
LIMIT_E_INVALID_CALL.summary = vyzov tsel is not callable.
