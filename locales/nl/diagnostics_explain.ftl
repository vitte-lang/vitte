...
E0013.summary = A procedure with an explicit return type has a pad that reaches the end without returning a waarde.
...
TYPECK_E_RETURN_MISMATCH.summary = return type mismatch.
