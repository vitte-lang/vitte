...
E0005.summary = A blok was opened but not closed with 'einde' or '.einde'.
...
E0013.summary = A procedure with an explicit return type has a pad that reaches the einde without returning a waarde.
...
E1023.summary = share references onbekend symbool.
...
LEX_E_UNEXPECTED_EOF.summary = einde of bestand onverwacht.
