...
E0013.summary = proc가 값을 반환하지 않고 종료될 수 있음.
...
E_CLI_IO.summary = The compiler cannot read the requested 입력 파일.
...
E_CLI_MISSING_ARG.summary = 누락된 command 인수.
...
E_CLI_UNKNOWN_COMMAND.summary = 알 수 없는 compiler command.
...
E_CLI_UNKNOWN_OPTION.summary = 알 수 없는 compiler option.
...
E_CLI_INVALID_ARGUMENT.summary = 잘못된 compiler 인수.
...
E_IO_FILE_NOT_FOUND.summary = 입력 파일누락.
...
E_IO_FILE_UNREADABLE.summary = 입력 파일 is not readable.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot 쓰기 출력 파일.
...
E_IO_DIRECTORY_NOT_FOUND.summary = 출력 directory누락.
...
E_IO_OVERWRITE_FORBIDDEN.summary = refusing to overwrite existing 출력.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline실패.
...
DRIVER_E_ANALYSIS_INVALID.summary = analysis 잘못됨.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = 코드 생성 ir incomplete.
...
DRIVER_E_FRONTEND_INPUT_NOT_LOADED.summary = frontend 입력 not loaded.
...
DRIVER_E_FRONTEND_INVALID.summary = frontend 잘못됨.
...
DRIVER_E_INVALID_LINK_PROFILE.summary = 잘못된 link 프로필.
...
DRIVER_E_IR_INVALID.summary = ir 잘못됨.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link 코드 생성 incomplete.
...
DRIVER_E_MIR_ANALYSIS_INVALID.summary = mir analysis 잘못됨.
...
DRIVER_E_MIR_INVALID.summary = mir 잘못됨.
...
DRIVER_E_NO_INPUT.summary = no 입력.
...
DRIVER_E_PARSE_EMPTY_AST.summary = parse 비어 있음 ast.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse 비어 있음 소스.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process실패.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was누락.
...
LINK_E_COMMAND_FAILED.summary = linker command실패.
...
PARSE_E_OLD_VITTE_SYNTAX.summary = old Vitte 구문 is not canonical.
...
AST_E_UNKNOWN_FIELD.summary = 알 수 없는 form 필드.
...
AST_E_MISSING_FIELD.summary = 누락된 form 필드.
...
AST_E_FIELD_TYPE_MISMATCH.summary = form 필드 타입불일치.
...
TYPECK_E_PICK_NON_EXHAUSTIVE.summary = pick 패턴 is not exhaustive.
...
TYPECK_E_IMPOSSIBLE_PATTERN.summary = pick 패턴 can never match.
...
TYPECK_E_MISSING_GIVE.summary = 누락된 give in 값 procedure.
...
TYPECK_E_GIVE_IN_VOID_PROC.summary = give 값 in procedure without 반환 타입.
...
TYPECK_E_CONTROL_PATH_MISSING_GIVE.summary = control 경로 reaches end without give.
...
TYPECK_W_UNREACHABLE_AFTER_GIVE.summary = code after give is 도달 불가.
...
TYPECK_E_IMMUTABLE_ASSIGN.summary = cannot assign to immutable 바인딩.
...
TYPECK_W_MUTABLE_NEVER_MODIFIED.summary = 변경 가능 바인딩 is never changed.
...
TYPECK_E_REASSIGNMENT_FORBIDDEN.summary = 대상 cannot be reassigned.
...
TYPECK_E_MISSING_INITIALIZER.summary = let 바인딩 requires an initializer or 타입.
...
TYPECK_E_INFERENCE_FAILED.summary = 바인딩 타입 could not be inferred.
...
TYPECK_E_INVALID_CALL_TARGET.summary = 호출 대상 is not callable.
...
TYPECK_E_UNKNOWN_NAMED_ARGUMENT.summary = named 인수 has no matching parameter.
...
TYPECK_E_ARGUMENT_ORDER.summary = 호출 인수 are in the wrong order.
...
TYPECK_E_AMBIGUOUS_CALL.summary = procedure 호출 is ambiguous.
...
TYPECK_E_NOT_CALLABLE.summary = 값 is not callable.
...
TYPECK_E_IMPL_MISSING_MEMBER.summary = implementation is 누락 a required 멤버.
...
TYPECK_E_IMPL_SIGNATURE_MISMATCH.summary = implementation 멤버 signature does not match.
...
BORROWCK_E_PARTIAL_MOVE.summary = 값 partially 이동됨.
...
BORROWCK_E_MUTABLE_SHARED_CONFLICT.summary = 변경 가능 and 공유 borrows overlap.
...
BORROWCK_E_REFERENCE_OUTLIVES_VALUE.summary = 참조 outlives the 값 it points to.
...
IR_E_INVALID_FUNCTION.summary = 잘못된 procedure.
...
DRIVER_E_MISSING_COMMAND.summary = 누락된 compiler command.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = 누락된 compiler option 값.
...
DRIVER_E_SOURCE_UNREADABLE.summary = 누락된 or unreadable 입력 소스.
...
DRIVER_E_INVALID_CONFIGURATION.summary = 잘못된 compiler configuration.
...
DRIVER_E_MISSING_TARGET.summary = 누락된 compiler 대상.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = 누락된 compiler 출력 directory.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = 누락된 compiler 출력 경로.
...
DRIVER_E_INVALID_LINK_TARGET.summary = 잘못된 compiler link 대상.
...
E_BOOTSTRAP_BANNER.summary = bootstrap banner is 잘못됨.
...
E_BOOTSTRAP_CONST_SIGNATURE.summary = bootstrap 상수 signature is 잘못됨.
...
E_BOOTSTRAP_EXPORT.summary = bootstrap export is 잘못됨.
...
E_BOOTSTRAP_MAIN_BODY.summary = bootstrap main body is 잘못됨.
...
E_BOOTSTRAP_MAIN_SIGNATURE.summary = bootstrap main signature is 잘못됨.
...
E_BOOTSTRAP_PROC_BODY.summary = bootstrap procedure body is 잘못됨.
...
E_BOOTSTRAP_PROC_SIGNATURE.summary = bootstrap procedure signature is 잘못됨.
...
E_BOOTSTRAP_SPACE.summary = bootstrap space 선언 is 잘못됨.
...
E_BOOTSTRAP_TOP_LEVEL.summary = bootstrap top-level 선언 is 잘못됨.
...
E_BOOTSTRAP_VERSION.summary = bootstrap version is 잘못됨.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command실패.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command실패.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package 가져오기 test실패.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is 누락.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package 소스 파일 is 누락.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check실패.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package 가져오기 check실패.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check실패.
...
SYNTAX_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
NAME_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
MODULE_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
TYPE_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
GENERIC_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
TRAIT_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
OWNERSHIP_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
LIFETIME_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
CONST_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
MACRO_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
HIR_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
MIR_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
IR_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
BACKEND_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
LINK_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
RUNTIME_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
DRIVER_E_INVALID_CALL.summary = 호출 대상 is not callable.
...
LIMIT_E_INVALID_CALL.summary = 호출 대상 is not callable.
