...
E_CLI_MISSING_ARG.summary = command argomento mancante.
...
E_CLI_UNKNOWN_COMMAND.summary = compiler command sconosciuto.
...
E_CLI_UNKNOWN_OPTION.summary = compiler option sconosciuto.
...
E_CLI_INVALID_ARGUMENT.summary = compiler argomento non valido.
...
E_IO_FILE_NOT_FOUND.summary = input file mancante.
...
E_IO_OUTPUT_UNWRITABLE.summary = cannot scrittura output file.
...
E_IO_DIRECTORY_NOT_FOUND.summary = output directory mancante.
...
DRIVER_E_PIPELINE_FAILURE.summary = compiler pipeline fallito.
...
DRIVER_E_ANALYSIS_INVALID.summary = analysis non valido.
...
DRIVER_E_CODEGEN_IR_INCOMPLETE.summary = generazione codice ir incomplete.
...
DRIVER_E_FRONTEND_INVALID.summary = frontend non valido.
...
DRIVER_E_INVALID_LINK_PROFILE.summary = link profilo non valido.
...
DRIVER_E_IR_INVALID.summary = ir non valido.
...
DRIVER_E_LINK_CODEGEN_INCOMPLETE.summary = link generazione codice incomplete.
...
DRIVER_E_MIR_ANALYSIS_INVALID.summary = mir analysis non valido.
...
DRIVER_E_MIR_INVALID.summary = mir non valido.
...
DRIVER_E_PARSE_EMPTY_AST.summary = parse vuoto ast.
...
DRIVER_E_PARSE_EMPTY_SOURCE.summary = parse vuoto sorgente.
...
DRIVER_E_RUN_PROCESS_FAILED.summary = run process fallito.
...
BACKEND_E_MISSING_C_COMPILER.summary = required C compiler was mancante.
...
LINK_E_COMMAND_FAILED.summary = linker command fallito.
...
DRIVER_E_MISSING_COMMAND.summary = compiler command mancante.
...
DRIVER_E_MISSING_OPTION_VALUE.summary = compiler option valore mancante.
...
DRIVER_E_SOURCE_UNREADABLE.summary = or unreadable input sorgente mancante.
...
DRIVER_E_INVALID_CONFIGURATION.summary = compiler configuration non valido.
...
DRIVER_E_MISSING_TARGET.summary = compiler destinazione mancante.
...
DRIVER_E_MISSING_OUTPUT_DIR.summary = compiler output directory mancante.
...
DRIVER_E_MISSING_OUTPUT_PATH.summary = compiler output percorso mancante.
...
DRIVER_E_INVALID_LINK_TARGET.summary = compiler link destinazione non valido.
...
INSTALL_E_VITTE_HELP_FAILED.summary = installed vitte help command fallito.
...
INSTALL_E_VITTEC_HELP_FAILED.summary = installed vittec help command fallito.
...
INSTALL_E_PACKAGE_IMPORT_TEST_FAILED.summary = installed package importazione test fallito.
...
INSTALL_E_COMPLETION_MISSING.summary = installed shell completion is mancante.
...
INSTALL_E_PACKAGE_SOURCE_MISSING.summary = package sorgente file is mancante.
...
INSTALL_E_POSTINSTALL_HELP_FAILED.summary = postinstall vitte help check fallito.
...
INSTALL_E_POSTINSTALL_IMPORT_TEST_FAILED.summary = postinstall package importazione check fallito.
...
INSTALL_E_POSTINSTALL_COMPLETION_MISSING.summary = postinstall shell completion check fallito.
