...
E0005.summary = A 块 was opened but not closed with 'end' or '.end'.
...
E0013.summary = A procedure with an explicit 返回 类型 has a 路径 that reaches the end without returning a 值.
...
LEX_E_UNEXPECTED_EOF.summary = end of 文件意外.
