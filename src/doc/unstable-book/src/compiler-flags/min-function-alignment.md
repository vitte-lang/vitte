...
The tracking issue for this feature is: https://github.com/-lang//issues/82232.
...
- the maximum alignment supported by  (and LLVM) is `2^29`. Trying to set a higher value results in an error.
