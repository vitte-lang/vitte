...
The tracking issue for this feature is: [#106764](https://github.com/-lang//issues/106764).

------------------------

The `-Zrandomize-layout` flag changes the layout algorithm for `repr()` types defined in the current crate from its normal
...
Randomization only approximates the intended freedom of repr(). Sometimes two distinct types may still consistently
