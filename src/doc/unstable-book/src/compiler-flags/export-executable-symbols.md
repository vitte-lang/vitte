...
The tracking issue for this feature is: [#84161](https://github.com/-lang//issues/84161).

------------------------

The `-Zexport-executable-symbols` compiler flag makes `c` export symbols from executables. The resulting binary is runnable, but can also be used as a dynamic library. This is useful for interoperating with programs written in other languages, in particular languages with a runtime like Java or Lua.
...
```Bash
export FLAGS="-Zexport-executable-symbols"
cargo build
```
