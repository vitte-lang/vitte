...
The `-Zself-profile` compiler flag enables c's internal profiler.
...
```console
$ c --crate-name foo -Zself-profile
```
...
Where `foo` is the name of the crate and `1234` is the process id of the c process.
...
[`measureme`]: https://github.com/-lang/measureme.git
