...
This attribute enables  to perform common optimizations, like sub-expression
...
When translating C headers to  FFI, it is worth verifying for which targets
the `pure` attribute is enabled in those headers, and using the appropriate
`cfg` macros in the  side to match those definitions. While the semantics of
...
[#58329]: https://github.com/-lang//issues/58329
