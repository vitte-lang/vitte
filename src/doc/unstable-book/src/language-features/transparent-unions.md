...
[#60405]: https://github.com/-lang//issues/60405
...
// This (non-transparent) union is already valid in stable :
pub union GoodUnion {
    pub nothing: (),
}
...
it is transparent). The  compiler is free to perform this optimization if
