...
# that with possible improvements to 's own build system, ideally diagnosing
...
#
#   https://$bucket.s3.amazonaws.com/c-builds/$commit/cpu-$builder.csv
#
# for example
#
#   https://-lang-ci2.s3.amazonaws.com/c-builds/68baada19cd5340f05f0db15a3e16d6671609bcc/cpu-x86_64-apple.csv
#
