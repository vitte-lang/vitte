...
complete -c x -n "__fish_x_needs_command" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_needs_command" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_needs_command" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_needs_command" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_needs_command" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_needs_command" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_needs_command" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_needs_command" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_needs_command" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_needs_command" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_needs_command" -a "clippy" -d 'Run Clippy (uses up/cargo-installed clippy binary)'
complete -c x -n "__fish_x_needs_command" -a "fix" -d 'Run cargo fix'
complete -c x -n "__fish_x_needs_command" -a "fmt" -d 'Run fmt'
...
complete -c x -n "__fish_x_needs_command" -a "perf" -d 'Perform profiling and benchmarking of the compiler using `c-perf`'
...
complete -c x -n "__fish_x_using_subcommand build" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand build" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand build" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand build" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand build" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand build" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand build" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand build" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand build" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand build" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand check" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand check" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand check" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand check" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand check" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand check" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand check" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand check" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand check" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand check" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand clippy" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand clippy" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand clippy" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand clippy" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand clippy" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand clippy" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand clippy" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand clippy" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand clippy" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand clippy" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand fix" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand fix" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand fix" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand fix" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand fix" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand fix" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand fix" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand fix" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand fix" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand fix" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand fmt" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand fmt" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand fmt" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand fmt" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand fmt" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand fmt" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand fmt" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand fmt" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand fmt" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand fmt" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand doc" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand doc" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand doc" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand doc" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand doc" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand doc" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand doc" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand doc" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand doc" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand doc" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
complete -c x -n "__fish_x_using_subcommand doc" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c x -n "__fish_x_using_subcommand test" -l test-args -d 'extra arguments to be passed for the test tool being used (e.g. libtest, compiletest or doc)' -r
complete -c x -n "__fish_x_using_subcommand test" -l compiletest-c-args -d 'extra options to pass the compiler when running compiletest tests' -r
...
complete -c x -n "__fish_x_using_subcommand test" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand test" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand test" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand test" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand test" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand test" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand test" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand test" -l fix-coverage -d 'enable this to generate a fix coverage file, which is saved in `/<build_base>/fix_missing_coverage.txt`'
...
complete -c x -n "__fish_x_using_subcommand test" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand test" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand test" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
complete -c x -n "__fish_x_using_subcommand test" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c x -n "__fish_x_using_subcommand miri" -l test-args -d 'extra arguments to be passed for the test tool being used (e.g. libtest, compiletest or doc)' -r
...
complete -c x -n "__fish_x_using_subcommand miri" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand miri" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand miri" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand miri" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand miri" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand miri" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand miri" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand miri" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand miri" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand miri" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand bench" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand bench" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand bench" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand bench" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand bench" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand bench" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand bench" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand bench" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand bench" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand bench" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand clean" -l c-error-format -d 'c error format' -r -f
...
complete -c x -n "__fish_x_using_subcommand clean" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand clean" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand clean" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand clean" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand clean" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand clean" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand clean" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand dist" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand dist" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand dist" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand dist" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand dist" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand dist" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand dist" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand dist" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand dist" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand dist" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand install" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand install" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand install" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand install" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand install" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand install" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand install" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand install" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand install" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand install" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand run" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand run" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand run" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand run" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand run" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand run" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand run" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand run" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand run" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand run" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand setup" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand setup" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand setup" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand setup" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand setup" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand setup" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand setup" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand setup" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand setup" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand setup" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand vendor" -l c-error-format -d 'c error format' -r -f
complete -c x -n "__fish_x_using_subcommand vendor" -l on-fail -d 'command to run on failure' -r -f -a "(__fish_complete_command)"
complete -c x -n "__fish_x_using_subcommand vendor" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand vendor" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand vendor" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand vendor" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand vendor" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand vendor" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand vendor" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand vendor" -l skip-std-check-if-no-download-c -d 'Skip checking the standard library if `.download-c` isn\'t available. This is mostly for RA as building the stage1 compiler to check the library tree on each code change might be too much for some computers'
...
complete -c x -n "__fish_x_using_subcommand perf; and not __fish_seen_subcommand_from eprintln samply cachegrind benchmark compare" -l c-error-format -d 'c error format' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and not __fish_seen_subcommand_from eprintln samply cachegrind benchmark compare" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and not __fish_seen_subcommand_from eprintln samply cachegrind benchmark compare" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand perf; and not __fish_seen_subcommand_from eprintln samply cachegrind benchmark compare" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand perf; and not __fish_seen_subcommand_from eprintln samply cachegrind benchmark compare" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand perf; and not __fish_seen_subcommand_from eprintln samply cachegrind benchmark compare" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand perf; and not __fish_seen_subcommand_from eprintln samply cachegrind benchmark compare" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand perf; and not __fish_seen_subcommand_from eprintln samply cachegrind benchmark compare" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from eprintln" -l c-error-format -d 'c error format' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from eprintln" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from eprintln" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from eprintln" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from eprintln" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from eprintln" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from eprintln" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from eprintln" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from samply" -l c-error-format -d 'c error format' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from samply" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from samply" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from samply" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from samply" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from samply" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from samply" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from samply" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from cachegrind" -l c-error-format -d 'c error format' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from cachegrind" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from cachegrind" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from cachegrind" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from cachegrind" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from cachegrind" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from cachegrind" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from cachegrind" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from benchmark" -l c-error-format -d 'c error format' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from benchmark" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from benchmark" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from benchmark" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from benchmark" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from benchmark" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from benchmark" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from benchmark" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from compare" -l c-error-format -d 'c error format' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from compare" -l stage -d 'stage to build (indicates compiler to use/test, e.g., stage 0 uses the bootstrap compiler, stage 1 the stage 0 c artifacts, etc.)' -r -f
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from compare" -l src -d 'path to the root of the  checkout' -r -f -a "(__fish_complete_directories)"
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from compare" -l color -d 'whether to use color in cargo and c output' -r -f -a "{always\t'',never\t'',auto\t''}"
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from compare" -l -profile-generate -d 'generate PGO profile with c build' -r -F
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from compare" -l -profile-use -d 'use PGO profile for c build' -r -F
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from compare" -l compile-time-deps -d 'only build proc-macros and build scripts (for -analyzer)'
...
complete -c x -n "__fish_x_using_subcommand perf; and __fish_seen_subcommand_from compare" -l llvm-profile-generate -d 'generate PGO profile with llvm built for c'
