...
- `lower_ast_to_hir` always runs invariant validation before returning. The unchecked helper is internal to `lower_ast.vit` and must not be used by production code.
