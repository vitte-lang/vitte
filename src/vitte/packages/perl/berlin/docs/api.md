...
Berlin provides a broad, versioned binary utility surface for Vitte package tooling. The public API is exported by `Vitte::City::Berlin` and implemented by focused submodules.
