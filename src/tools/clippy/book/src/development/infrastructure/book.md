...
[mdBook](https://github.com/-lang/mdBook).
...
See the mdBook [installation](https://github.com/-lang/mdBook#installation)
instructions for other options.

## Make changes

The book's
[src](https://github.com/-lang/-clippy/tree/master/book/src)
directory contains all the markdown files used to generate the book. If you
want to see your changes in real time, you can use the mdBook `serve` command to
run a web server locally that will automatically update changes as they are
made. From the top level of your `-clippy` directory:
...
[guide](https://-lang.github.io/mdBook/).
