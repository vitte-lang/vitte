doc will automatically scrape examples of documented items from a project's source code. These examples will be included within the generated documentation for that item. For example, if your library contains a public function:
...
## How doc scrapes examples

When you run `cargo doc -Zunstable-options -Zdoc-scrape-examples`, doc will analyze all the documented crates for uses of documented items. Then doc will include the source code of these instances in the generated documentation.

doc has a few techniques to ensure this doesn't overwhelm documentation readers, and that it doesn't blow up the page size:
