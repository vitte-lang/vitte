# 46. Performance: structures de donnees adaptees (version poche)

Prérequis: `book/poche/SOMMAIRE.md`.
Voir aussi: `book/chapters/46-performance-structures-adaptees.md`.

## Objectif

Comprendre performance: structures de donnees adaptees de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de performance: structures de donnees adaptees, puis vérifiez le résultat attendu.
...
Version complète: `book/chapters/46-performance-structures-adaptees.md`.
