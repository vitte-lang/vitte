# 08. Structures de données (version poche)

Prérequis: `book/poche/SOMMAIRE.md`.
Voir aussi: `book/chapters/08-structures.md`.

## Objectif

Comprendre structures de données de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de structures de données, puis vérifiez le résultat attendu.
...
Version complète: `book/chapters/08-structures.md`.
