# 09. Modules et organisation (version poche)

Prérequis: `book/poche/SOMMAIRE.md`.
Voir aussi: `book/chapters/09-modules.md`.

## Objectif

Comprendre modules et organisation de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de modules et organisation, puis vérifiez le résultat attendu.
...
Version complète: `book/chapters/09-modules.md`.
