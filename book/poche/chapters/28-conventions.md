# 28. Conventions de code (version poche)

Prérequis: `book/poche/SOMMAIRE.md`.
Voir aussi: `book/chapters/28-conventions.md`.

## Objectif

Comprendre conventions de code de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de conventions de code, puis vérifiez le résultat attendu.
...
Version complète: `book/chapters/28-conventions.md`.
