# 17. Packages (version poche)

Prérequis: `book/poche/SOMMAIRE.md`.
Voir aussi: `book/chapters/17-stdlib.md`.

## Objectif

Comprendre packages de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de packages, puis vérifiez le résultat attendu.
...
Version complète: `book/chapters/17-stdlib.md`.
