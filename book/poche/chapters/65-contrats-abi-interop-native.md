# 65. Contrats ABI et interop native (version poche)

Prérequis: `book/poche/SOMMAIRE.md`.
Voir aussi: `book/chapters/65-contrats-abi-interop-native.md`.

## Objectif

Comprendre contrats abi et interop native de manière simple pour agir rapidement.
...
Modifiez l'exemple pour créer une variante de contrats abi et interop native, puis vérifiez le résultat attendu.
...
Version complète: `book/chapters/65-contrats-abi-interop-native.md`.
