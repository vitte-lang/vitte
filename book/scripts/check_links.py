...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check markdown internal links under book/")
    parser.add_argument("--book-root", default="book", help="book root directory")
