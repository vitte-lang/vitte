...
TARGETS = [
    Path('book/chapters/01-demarrer.md'),
    Path('book/chapters/02-philosophie.md'),
    Path('book/chapters/03-projet.md'),
    Path('book/chapters/04-syntaxe.md'),
    Path('book/chapters/05-types.md'),
    Path('book/chapters/06-procedures.md'),
    Path('book/chapters/07-controle.md'),
    Path('book/chapters/08-structures.md'),
    Path('book/chapters/09-modules.md'),
    Path('book/chapters/10-diagnostics.md'),
]
