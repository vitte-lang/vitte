...
Le coeur de **performance: structures de donnees adaptees** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **performance: structures de donnees adaptees**, posez systématiquement ces questions:
...
Cas: un module lié à **performance: structures de donnees adaptees** (46-performance-structures-adaptees.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **performance: structures de donnees adaptees**.
