...
Cette section s'appuie sur du code concret pour **interop et abi**.
...
1. `form Request {` -> participe au flux nominal du programme.
2. `code: int` -> participe au flux nominal du programme.
3. `payload: string` -> participe au flux nominal du programme.
4. `}` -> participe au flux nominal du programme.
5. `proc encode_code(r: Request) -> int {` -> déclare un contrat clair (entrées/sortie).
6. `give r.code` -> renvoie une valeur observable et testable.
...
1. `form Request {` -> participe au flux nominal.
2. `code: int` -> participe au flux nominal.
3. `payload: string` -> participe au flux nominal.
4. `}` -> participe au flux nominal.
5. `proc encode_code(r: Request) -> int {` -> déclare une procédure avec contrat explicite.
6. `give r.code` -> retourne le résultat observé.
...
### Atelier concret: cas pratique sur 16-interop.md
