...
Le coeur de **gestion des erreurs semantiques** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **gestion des erreurs semantiques**, posez systématiquement ces questions:
...
Cas: un module lié à **gestion des erreurs semantiques** (57-gestion-erreurs-semantiques.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **gestion des erreurs semantiques**.
