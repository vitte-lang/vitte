...
Cette section s'appuie sur du code concret pour **gestion des erreurs semantiques**.
...
2. `return unknown_name` -> renvoie une valeur observable et testable.
...
2. `return unknown_name` -> retourne le résultat observé.
...
### Atelier concret: cas pratique sur 57-gestion-erreurs-semantiques.md
