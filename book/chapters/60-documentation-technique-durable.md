...
Cette section s'appuie sur du code concret pour **documentation technique durable**.
...
2. `emit 1` -> participe au flux nominal du programme.
...
2. `emit 1` -> participe au flux nominal.
...
### Atelier concret: cas pratique sur 60-documentation-technique-durable.md
