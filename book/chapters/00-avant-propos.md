...
Le coeur de **avant-propos** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **avant-propos**, posez systématiquement ces questions:
...
Cas: un module lié à **avant-propos** (00-avant-propos.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **avant-propos**.
