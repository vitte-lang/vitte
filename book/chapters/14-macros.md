...
Le coeur de **macros** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **macros**, posez systématiquement ces questions:
...
Cas: un module lié à **macros** (14-macros.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **macros**.
