...
Le coeur de **performance** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **performance**, posez systématiquement ces questions:
...
Cas: un module lié à **performance** (19-performance.md) doit évoluer sans casser l'existant.
