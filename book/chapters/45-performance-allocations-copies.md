...
Le coeur de **performance: allocations et copies** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **performance: allocations et copies**, posez systématiquement ces questions:
...
Cas: un module lié à **performance: allocations et copies** (45-performance-allocations-copies.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **performance: allocations et copies**.
