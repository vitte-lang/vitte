...
Cette section s'appuie sur du code concret pour **structure d'un projet**.
...
2. `form Ticket {` -> participe au flux nominal du programme.
3. `id: int` -> participe au flux nominal du programme.
4. `priority: int` -> participe au flux nominal du programme.
...
1. `space app/domain` -> positionne le code dans son module.
2. `form Ticket {` -> participe au flux nominal.
3. `id: int` -> participe au flux nominal.
4. `priority: int` -> participe au flux nominal.
...
### Atelier concret: cas pratique sur 03-projet.md
