...
Le coeur de **tracage et observabilite** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **tracage et observabilite**, posez systématiquement ces questions:
...
Cas: un module lié à **tracage et observabilite** (48-tracage-observabilite.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **tracage et observabilite**.
