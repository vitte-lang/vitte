...
Le coeur de **modele mental du compilateur** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **modele mental du compilateur**, posez systématiquement ces questions:
...
Cas: un module lié à **modele mental du compilateur** (34-modele-mental-compilateur.md) doit évoluer sans casser l'existant.
