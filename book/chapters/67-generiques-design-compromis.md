...
Le coeur de **generiques: design et compromis** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **generiques: design et compromis**, posez systématiquement ces questions:
...
Cas: un module lié à **generiques: design et compromis** (67-generiques-design-compromis.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **generiques: design et compromis**.
