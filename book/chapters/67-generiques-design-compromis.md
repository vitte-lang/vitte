...
Cette section s'appuie sur du code concret pour **generiques: design et compromis**.
...
1. `type Box[T] = T` -> participe au flux nominal du programme.
...
1. `type Box[T] = T` -> participe au flux nominal.
...
### Atelier concret: cas pratique sur 67-generiques-design-compromis.md
