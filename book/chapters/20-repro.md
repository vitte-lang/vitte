...
Thème: **reproductibilité**. Cette section évite les généralités et part d'un extrait réel.
...
1. `proc stable(x: int) -> int {` -> pose un contrat clair de fonction.
2. `give x * 2 + 1` -> renvoie la sortie vérifiable.
