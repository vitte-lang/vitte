...
Le coeur de **reproductibilité** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **reproductibilité**, posez systématiquement ces questions:
...
Cas: un module lié à **reproductibilité** (20-repro.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **reproductibilité**.
