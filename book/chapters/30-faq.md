...
Cette section s'appuie sur du code concret pour **faq**.
...
1. `emit 10 + 20` -> participe au flux nominal du programme.
2. `# erreur: `emit` est un statement, pas une déclaration top-level.` -> participe au flux nominal du programme.
...
1. `emit 10 + 20` -> participe au flux nominal.
2. `# erreur: `emit` est un statement, pas une déclaration top-level.` -> participe au flux nominal.
...
### Atelier concret: cas pratique sur 30-faq.md
