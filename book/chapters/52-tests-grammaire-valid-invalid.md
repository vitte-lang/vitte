...
Exemple approfondi pour **tests grammaire valid invalid**: chaîne d'analyse complète (scan -> parse -> validation structurelle -> projection diagnostic).
...
Scénarios recommandés (tests grammaire valid invalid):
