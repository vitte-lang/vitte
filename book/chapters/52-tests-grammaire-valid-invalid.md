...
Cette section s'appuie sur du code concret pour **tests de grammaire (valid/invalid corpus)**.
...
### Atelier concret: cas pratique sur 52-tests-grammaire-valid-invalid.md
