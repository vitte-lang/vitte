...
Le coeur de **pipeline compilateur** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **pipeline compilateur**, posez systématiquement ces questions:
...
Cas: un module lié à **pipeline compilateur** (15-pipeline.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **pipeline compilateur**.
