...
Le coeur de **projet guide http** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **projet guide http**, posez systématiquement ces questions:
...
Cas: un module lié à **projet guide http** (22-projet-http.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **projet guide http**.
