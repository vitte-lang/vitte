...
Cette section s'appuie sur du code concret pour **mapping ast -> ir (vue pratique)**.
...
1. `entry main at app/demo { return 1 + 2 }` -> définit le point d'entrée exécutable.
...
1. `entry main at app/demo { return 1 + 2 }` -> définit l'entrée du programme.
...
### Atelier concret: cas pratique sur 64-mapping-ast-vers-ir.md
