...
Le coeur de **mapping ast -> ir (vue pratique)** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **mapping ast -> ir (vue pratique)**, posez systématiquement ces questions:
...
Cas: un module lié à **mapping ast -> ir (vue pratique)** (64-mapping-ast-vers-ir.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **mapping ast -> ir (vue pratique)**.
