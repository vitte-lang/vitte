...
Le coeur de **contrats abi et interop native** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **contrats abi et interop native**, posez systématiquement ces questions:
...
Cas: un module lié à **contrats abi et interop native** (65-contrats-abi-interop-native.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **contrats abi et interop native**.
