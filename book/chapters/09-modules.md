...
Le coeur de **modules et organisation** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **modules et organisation**, posez systématiquement ces questions:
...
Cas: un module lié à **modules et organisation** (09-modules.md) doit évoluer sans casser l'existant.
