...
Le coeur de **design d'api publiques stables** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **design d'api publiques stables**, posez systématiquement ces questions:
...
Cas: un module lié à **design d'api publiques stables** (39-design-api-publiques-stables.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **design d'api publiques stables**.
