...
Cette section s'appuie sur du code concret pour **erreurs de build**.
...
1. `emit 1` -> participe au flux nominal du programme.
2. `# casse: statement top-level.` -> participe au flux nominal du programme.
...
1. `emit 1` -> participe au flux nominal.
2. `# casse: statement top-level.` -> participe au flux nominal.
...
### Atelier concret: cas pratique sur 31-erreurs-build.md
