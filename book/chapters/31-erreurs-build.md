...
Le coeur de **erreurs de build** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **erreurs de build**, posez systématiquement ces questions:
...
Cas: un module lié à **erreurs de build** (31-erreurs-build.md) doit évoluer sans casser l'existant.
