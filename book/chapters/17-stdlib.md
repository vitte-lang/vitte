...
Le coeur de **packages** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **packages**, posez systématiquement ces questions:
...
Cas: un module lié à **packages** (17-stdlib.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **packages**.
