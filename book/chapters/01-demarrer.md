...
Cette section s'appuie sur du code concret pour **démarrer avec vitte**.
...
1. `entry main at core/app {` -> définit le point d'entrée exécutable.
...
1. `entry main at core/app {` -> définit l'entrée du programme.
...
### Atelier concret: cas pratique sur 01-demarrer.md
