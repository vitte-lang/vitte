...
Le coeur de **démarrer avec vitte** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **démarrer avec vitte**, posez systématiquement ces questions:
...
Cas: un module lié à **démarrer avec vitte** (01-demarrer.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **démarrer avec vitte**.
