...
Le coeur de **procédures et contrats** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **procédures et contrats**, posez systématiquement ces questions:
...
Cas: un module lié à **procédures et contrats** (06-procedures.md) doit évoluer sans casser l'existant.
