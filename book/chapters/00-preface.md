...
Le coeur de **préface** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **préface**, posez systématiquement ces questions:
...
Cas: un module lié à **préface** (00-preface.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **préface**.
