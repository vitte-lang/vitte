...
Le coeur de **syntaxe essentielle** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **syntaxe essentielle**, posez systématiquement ces questions:
...
Cas: un module lié à **syntaxe essentielle** (04-syntaxe.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **syntaxe essentielle**.
