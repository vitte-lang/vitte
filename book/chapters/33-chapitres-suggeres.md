...
Le coeur de **chapitres suggérés (max)** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **chapitres suggérés (max)**, posez systématiquement ces questions:
...
Cas: un module lié à **chapitres suggérés (max)** (33-chapitres-suggeres.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **chapitres suggérés (max)**.
