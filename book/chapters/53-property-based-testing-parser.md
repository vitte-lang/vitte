...
Le coeur de **property-based testing pour le parser** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **property-based testing pour le parser**, posez systématiquement ces questions:
...
Cas: un module lié à **property-based testing pour le parser** (53-property-based-testing-parser.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **property-based testing pour le parser**.
