...
Cette section s'appuie sur du code concret pour **property-based testing pour le parser**.
...
1. `entry main at app/demo { return 0 }` -> définit le point d'entrée exécutable.
...
1. `entry main at app/demo { return 0 }` -> définit l'entrée du programme.
...
### Atelier concret: cas pratique sur 53-property-based-testing-parser.md
