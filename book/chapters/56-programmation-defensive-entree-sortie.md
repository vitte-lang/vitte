...
Le coeur de **programmation defensive en entree/sortie** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **programmation defensive en entree/sortie**, posez systématiquement ces questions:
...
Cas: un module lié à **programmation defensive en entree/sortie** (56-programmation-defensive-entree-sortie.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **programmation defensive en entree/sortie**.
