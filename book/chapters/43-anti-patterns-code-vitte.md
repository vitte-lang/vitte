...
Le coeur de **anti-patterns frequents en code vitte** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **anti-patterns frequents en code vitte**, posez systématiquement ces questions:
...
Cas: un module lié à **anti-patterns frequents en code vitte** (43-anti-patterns-code-vitte.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **anti-patterns frequents en code vitte**.
