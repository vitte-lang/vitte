...
Le coeur de **tests d'integration orientes scenario** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **tests d'integration orientes scenario**, posez systématiquement ces questions:
...
Cas: un module lié à **tests d'integration orientes scenario** (50-tests-integration-scenario.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **tests d'integration orientes scenario**.
