...
Cette section s'appuie sur du code concret pour **tests d'integration orientes scenario**.
...
1. `entry main at app/cli {` -> définit le point d'entrée exécutable.
...
1. `entry main at app/cli {` -> définit l'entrée du programme.
...
### Atelier concret: cas pratique sur 50-tests-integration-scenario.md
