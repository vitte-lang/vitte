...
Le coeur de **fuzzing de l'entree source** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **fuzzing de l'entree source**, posez systématiquement ces questions:
...
Cas: un module lié à **fuzzing de l'entree source** (54-fuzzing-entree-source.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **fuzzing de l'entree source**.
