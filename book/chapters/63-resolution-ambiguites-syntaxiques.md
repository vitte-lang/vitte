...
Le coeur de **resolution d'ambiguites syntaxiques** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **resolution d'ambiguites syntaxiques**, posez systématiquement ces questions:
...
Cas: un module lié à **resolution d'ambiguites syntaxiques** (63-resolution-ambiguites-syntaxiques.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **resolution d'ambiguites syntaxiques**.
