...
Le coeur de **patterns de procedures robustes** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **patterns de procedures robustes**, posez systématiquement ces questions:
...
Cas: un module lié à **patterns de procedures robustes** (42-patterns-procedures-robustes.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **patterns de procedures robustes**.
