...
Le coeur de **architecture hexagonale en vitte** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **architecture hexagonale en vitte**, posez systématiquement ces questions:
...
Cas: un module lié à **architecture hexagonale en vitte** (68-architecture-hexagonale-vitte.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **architecture hexagonale en vitte**.
