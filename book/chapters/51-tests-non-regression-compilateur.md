...
Cette section s'appuie sur du code concret pour **tests de non-regression compilateur**.
...
### Atelier concret: cas pratique sur 51-tests-non-regression-compilateur.md
