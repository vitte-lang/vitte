...
Le coeur de **tests de non-regression compilateur** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **tests de non-regression compilateur**, posez systématiquement ces questions:
...
Cas: un module lié à **tests de non-regression compilateur** (51-tests-non-regression-compilateur.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **tests de non-regression compilateur**.
