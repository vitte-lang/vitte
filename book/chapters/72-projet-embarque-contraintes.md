...
Le coeur de **projet embarque (contraintes mémoire/temps)** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **projet embarque (contraintes mémoire/temps)**, posez systématiquement ces questions:
...
Cas: un module lié à **projet embarque (contraintes mémoire/temps)** (72-projet-embarque-contraintes.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **projet embarque (contraintes mémoire/temps)**.
