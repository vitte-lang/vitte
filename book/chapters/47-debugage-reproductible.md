...
Exemple approfondi pour **debugage reproductible**: pipeline diagnostic (capture, classification, redaction, projection sortie).
...
Scénarios recommandés (debugage reproductible):
