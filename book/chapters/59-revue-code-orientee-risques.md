...
Cette section s'appuie sur du code concret pour **revue de code orientee risques**.
...
3. `give x` -> renvoie une valeur observable et testable.
...
### Atelier concret: cas pratique sur 59-revue-code-orientee-risques.md
