...
Le coeur de **revue de code orientee risques** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **revue de code orientee risques**, posez systématiquement ces questions:
...
Cas: un module lié à **revue de code orientee risques** (59-revue-code-orientee-risques.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **revue de code orientee risques**.
