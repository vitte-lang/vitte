...
Cette section s'appuie sur du code concret pour **generation de diagrammes de grammaire**.
...
1. `stmt ::= return_stmt | expr_stmt ;` -> participe au flux nominal du programme.
...
1. `stmt ::= return_stmt | expr_stmt ;` -> participe au flux nominal.
...
### Atelier concret: cas pratique sur 61-generation-diagrammes-grammaire.md
