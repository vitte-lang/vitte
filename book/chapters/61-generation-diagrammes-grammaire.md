...
Le coeur de **generation de diagrammes de grammaire** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **generation de diagrammes de grammaire**, posez systématiquement ces questions:
...
Cas: un module lié à **generation de diagrammes de grammaire** (61-generation-diagrammes-grammaire.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **generation de diagrammes de grammaire**.
