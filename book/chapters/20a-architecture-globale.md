...
Le coeur de **architecture globale du langage** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **architecture globale du langage**, posez systématiquement ces questions:
...
Cas: un module lié à **architecture globale du langage** (20a-architecture-globale.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **architecture globale du langage**.
