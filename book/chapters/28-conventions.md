...
Le coeur de **conventions de code** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **conventions de code**, posez systématiquement ces questions:
...
Cas: un module lié à **conventions de code** (28-conventions.md) doit évoluer sans casser l'existant.
