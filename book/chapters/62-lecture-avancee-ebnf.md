...
Le coeur de **lecture avancee de l'ebnf du langage** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **lecture avancee de l'ebnf du langage**, posez systématiquement ces questions:
...
Cas: un module lié à **lecture avancee de l'ebnf du langage** (62-lecture-avancee-ebnf.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **lecture avancee de l'ebnf du langage**.
