...
Cette section s'appuie sur du code concret pour **lecture avancee de l'ebnf du langage**.
...
1. `let_stmt ::= "let" WS1 ident WS? "=" WS? expr ;` -> participe au flux nominal du programme.
...
1. `let_stmt ::= "let" WS1 ident WS? "=" WS? expr ;` -> participe au flux nominal.
...
### Atelier concret: cas pratique sur 62-lecture-avancee-ebnf.md
