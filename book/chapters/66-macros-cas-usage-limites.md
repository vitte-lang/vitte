...
Le coeur de **macros: cas d'usage et limites** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **macros: cas d'usage et limites**, posez systématiquement ces questions:
...
Cas: un module lié à **macros: cas d'usage et limites** (66-macros-cas-usage-limites.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **macros: cas d'usage et limites**.
