...
Le coeur de **ecriture de tests unitaires lisibles** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **ecriture de tests unitaires lisibles**, posez systématiquement ces questions:
...
Cas: un module lié à **ecriture de tests unitaires lisibles** (49-tests-unitaires-lisibles.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **ecriture de tests unitaires lisibles**.
