...
Le coeur de **projet complet service système** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **projet complet service système**, posez systématiquement ces questions:
...
Cas: un module lié à **projet complet service système** (71-projet-service-systeme.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **projet complet service système**.
