...
Le coeur de **diagnostics et erreurs** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **diagnostics et erreurs**, posez systématiquement ces questions:
...
Cas: un module lié à **diagnostics et erreurs** (10-diagnostics.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **diagnostics et erreurs**.
