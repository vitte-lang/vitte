...
Le coeur de **style d'architecture** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **style d'architecture**, posez systématiquement ces questions:
...
Cas: un module lié à **style d'architecture** (29-style.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **style d'architecture**.
