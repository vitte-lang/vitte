...
Le coeur de **projet guide éditeur** est de prendre des décisions lisibles et vérifiables.
...
Quand vous travaillez sur **projet guide éditeur**, posez systématiquement ces questions:
...
Cas: un module lié à **projet guide éditeur** (26-projet-editor.md) doit évoluer sans casser l'existant.
...
Cette section donne des exemples variés et réalistes pour **projet guide éditeur**.
