#ifndef VITTE_BOOTSTRAP_SRC_SCANNER_SCANNER_H_H
#define VITTE_BOOTSTRAP_SRC_SCANNER_SCANNER_H_H
...
typedef struct vitte_bootstrap_src_scanner_scanner_h_module {
    const char *name;
    const char *category;
    const char *purpose;
    uint32_t version;
} vitte_bootstrap_src_scanner_scanner_h_module_t;
...
#endif /* VITTE_BOOTSTRAP_SRC_SCANNER_SCANNER_H_H */
