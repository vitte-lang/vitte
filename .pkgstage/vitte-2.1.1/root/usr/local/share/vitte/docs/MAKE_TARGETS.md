...
make test
```
- `make quickstart-check` vérifie rapidement le chemin de démarrage avec les exemples de base.
- `make build` construit l'ensemble du projet et génère les artefacts principaux.
- `make test` exécute la suite de tests standard du compilateur.
