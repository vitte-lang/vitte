...
E0005.summary = A blok was opened but not closed with 'konets' or '.konets'.
...
E0013.summary = A procedure with an explicit vozvrat tip has a put that reaches the konets without returning a znachenie.
...
E1023.summary = share references neizvestnyi simvol.
...
LEX_E_UNEXPECTED_EOF.summary = konets of fail neozhidannyi.
