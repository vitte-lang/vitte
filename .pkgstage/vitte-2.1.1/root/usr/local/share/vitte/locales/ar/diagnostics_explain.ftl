...
E0005.summary = A كتلة was opened but not closed with 'نهاية' or '.نهاية'.
...
E0013.summary = A procedure with an explicit ارجاع نوع has a مسار that reaches the نهاية without returning a قيمة.
...
E1023.summary = share references مجهول رمز.
...
LEX_E_UNEXPECTED_EOF.summary = نهاية of ملف غير متوقع.
