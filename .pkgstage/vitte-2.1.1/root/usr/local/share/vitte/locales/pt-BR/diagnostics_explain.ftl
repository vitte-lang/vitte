...
E0005.summary = A bloco was opened but not closed with 'fim' or '.fim'.
...
E0013.summary = A procedure with an explicit retorno tipo has a caminho that reaches the fim without returning a valor.
...
E1023.summary = share references desconhecido simbolo.
...
LEX_E_UNEXPECTED_EOF.summary = fim of arquivo inesperado.
