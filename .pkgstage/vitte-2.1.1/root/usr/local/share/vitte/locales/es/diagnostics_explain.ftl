...
E0005.summary = A bloque was opened but not closed with 'fin' or '.fin'.
...
E0013.summary = A procedure with an explicit retorno tipo has a ruta that reaches the fin without returning a valor.
...
E1023.summary = share references desconocido simbolo.
...
LEX_E_UNEXPECTED_EOF.summary = fin of archivo inesperado.
